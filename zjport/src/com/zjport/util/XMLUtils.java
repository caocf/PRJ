...
/**
 * Created by Will on 2016/9/9 16:18.<br/>
 * 实现xml与Map之间转换
 * 支持从文件，输入流，字符串xml转Map
 * Map转xml文件，输出流，字符串XML<br/>
 * &lt;?xml version="1.0" encoding="UTF-8"? &gt;<br/>
 * &lt;XX&gt;<br/>
 *     &lt;a type="1"&gt;111&lt;/a&gt;<br/>
 *     &lt;a id="456" type="2"&gt;2&lt;/a&gt;<br/>
 * &lt;/XX&gt;<br/>
 *<br/>
 * {XX=<br/>
 *      {a=[<br/>
 *           {id=123, value=111, type=1},<br/>
 *           {id=456,value=2, type=2}<br/>
 *          ]<br/>
 *       }<br/>
 *  }<br/>
 */
...
//                        element.addElement(entry.getKey()).addText(String.valueOf(o));
    ...
    public static void main(String[] args) throws IOException, DocumentException {
        String str = "<?xml version=\"1.0\" encoding=\"GB2312\"?>\n" +
                ...
                "  <CameraID>1003</CameraID>\n" +
                "  <CameraName>石油化工东位置</CameraName>\n" +
                "  <DeviceIP></DeviceIP>\n" +
                ...
                "  <IsEhomeDevice>0</IsEhomeDevice>\n" +
                "  <DeviceIndexCode>0</DeviceIndexCode>\n" +
                "  <VagIp></VagIp>\n" +
                "  <VagPort></VagPort>\n" +
                "  <CameraIndexCode>41111131001310000001</CameraIndexCode>\n" +
                "  <StreamPu></StreamPu>\n" +
                "  <StreamCu>0</StreamCu>\n" +
                "  <RegionID>150</RegionID>\n" +
                "  <ControlUnitID>4</ControlUnitID>\n" +
                "  <Cascade>1</Cascade>\n" +
                "  <CascadeCameraIndexcode>330490000000000177</CascadeCameraIndexcode>\n" +
                "  <CascadeIasIp>10.100.70.201</CascadeIasIp>\n" +
                "  <CascadeIasPort>7099</CascadeIasPort>\n" +
                "  <CascadeDeviceType>0</CascadeDeviceType>\n" +
                "  <StreamServerIP></StreamServerIP>\n" +
                "  <StreamServerPort></StreamServerPort>\n" +
                "  <IsUseStreamServer>0</IsUseStreamServer>\n" +
                "  <DeviceID>1</DeviceID>\n" +
                "  <UserID>1</UserID>\n" +
                "  <PagIP></PagIP>\n" +
                "  <PagPort></PagPort>\n" +
                "  <UserSession>2b36c28b-3346-4812-9261-84a5860b19b9</UserSession>\n" +
                ...
                "  <SnapPicture>1</SnapPicture>\n" +
                "  <RecordVideo>1</RecordVideo>\n" +
                "  <ThreeDPosition>1</ThreeDPosition>\n" +
                "  <DigitalZoom>1</DigitalZoom>\n" +
                "  <ptzConfigPrivilege>1</ptzConfigPrivilege>\n" +
                "  <videoConfigPrivilege>1</videoConfigPrivilege>\n" +
                "</Parament>";
        Parament p = new Parament(str);
