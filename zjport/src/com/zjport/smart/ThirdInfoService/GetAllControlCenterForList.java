...
@XmlRootElement(name = "getAllControlCenterForList")
public class GetAllControlCenterForList {

    @XmlElementRef(name = "request", namespace = "http://webservice.cms.hikvision.com", type = JAXBElement.class, required = false)
