...
<section class="content" style="padding-top:0; margin-top: 5px;" >
    <div class="box box-primary" style="border-top: 0;background-color: rgb(241,242,246);margin-bottom: 15px;">
        <form class="form-horizontal" enctype="multipart/form-data" id="calendarForm" action="calendarSubmit" method="post">
        <input type="hidden" id="calendarId" name="calendarId" value="<%=calendar.getStCalendarId()%>"/>
        <div class="box-body">
            <div style="background-color: white;width:100%;padding-top: 10px;box-shadow: 0 0 3px #ccc;">
            <div class="form-group" >
                <label  class="col-sm-1 control-label">日程类型<span style="color: red">*</span>：</label>
                <div class="col-sm-11">
                    <div  style="width:200px;">
                        <select id="disabledSelect" name="calendarType" class="form-control"  style="background-color: rgb(250,250,250);">
                            <option name="choose" <%if(CommonConst.CALENDAR_COMMON.equals(calendar.getStType())) {%>selected="selected"<%}%> value="1">日常事物</option>
                            <option name="choose" <%if(CommonConst.CALENDAR_MEETING.equals(calendar.getStType())) {%>selected="selected"<%}%> value="2">会议安排</option>
                            <option name="choose" <%if(CommonConst.CALENDAR_WORK.equals(calendar.getStType())) {%>selected="selected"<%}%> value="3">工作安排</option>
                            <option name="choose" <%if(CommonConst.CALENDAR_ELSE.equals(calendar.getStType())) {%>selected="selected"<%}%> value="4">其他任务</option>
                        </select>
                    </div>
                </div>
            </div>
            <div class="form-group" style="margin-bottom: 10px;border-top: solid 1px #ccc;padding-top:10px;">
                <label for="title" class="col-sm-1 control-label">日程标题<span style="color: red">*</span>：</label>
                <div class="col-sm-11">
                    <input type="input" class="form-control" style="border: 0;" id="title" value="<%=calendar.getStCalendarTitle()%>" maxlength="60" name="title" placeholder="请输入文章标题，标题文字不能超过60个中文字符">
                </div>
            </div>
            <div class="form-group" style="margin-bottom: 10px;border-top: solid 1px #ccc;padding-top:10px;">
            ...
            <div class="form-group"style="margin-bottom: 0;">
                <textarea id="editor1" name="editor1" rows="10" cols="80" placeholder="请输入文章内容"><%=calendar.getStContent()%></textarea>
            </div>
                <div class="form-group " style="margin-bottom: 0;border-top: solid 1px #ccc;padding:10px 0;">
                    <label  class="col-sm-1 control-label" style="text-align: left;">紧急程度<span style="color: red">*</span>：</label>
                    <div class="col-sm-11 "  style="height:27px;color:#666">
                        <label class="checkbox-inline">
                            <input type="radio" name="calendarIsUrgent" autocomplete="off"
                                   value="1" <%if("1".equals(calendar.getStUrgentState())) {%>checked=true<%}%>> 一般
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="calendarIsUrgent"  autocomplete="off"
                                   value="2" <%if("2".equals(calendar.getStUrgentState())) {%>checked=true<%}%>> 重要
                        </label>
                        <label class="checkbox-inline">
                            <input type="radio" name="calendarIsUrgent"  autocomplete="off"
                                   value="3" <%if("3".equals(calendar.getStUrgentState())) {%>checked=true<%}%>>紧急
                        </label>
                    </div>
                </div>
                <div class="form-group" style="margin-bottom: 10px;border-top: solid 1px #ccc;padding-top:10px;">
                    <label class="col-sm-1 control-label" style="text-align: left;">收件人<span style="color: red">*</span>：</label>
                    <div class="col-sm-10" style="padding-top:7px;">
                        <input type="hidden" id="useridstr" name="useridstr" value="<%=userIds%>"/>
                        <span id='usernamespan' style="display: block;width: 90%;overflow: hidden;text-overflow:ellipsis; word-break:keep-all;white-space:nowrap;"><%=userNames%></span>
                    </div>
                ...
                <div class="form-group" style="margin-bottom: 10px;border-top: solid 1px #ccc;padding-top:10px;">
                    <label class="col-sm-1 control-label" style="text-align: left;">时间<span style="color: red">*</span>：</label>
                    <div class="col-sm-10" >
                        <div style="float:left;">
                            <input type="text" value="<%=calendar.getDtStart()%>" placeholder="起始时间" id="beginTime" name="beginTime" onFocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endTime\')}'})" readonly="readonly" class="Wdate" style="float:left;margin-left:10px;height:30px;line-height: 30px;padding-left:10px;border-radius:4px;border: solid 1px #ccc;" />
                            ...
                            <input type="text" value="<%=calendar.getDtEnd()%>" id="endTime" name="endTime" placeholder="结束时间" onFocus="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'beginTime\')}'})" readonly="readonly" class="Wdate" style="float:left;margin-left:10px;height:30px;line-height: 30px;padding-left:10px;border-radius:4px;border: solid 1px #ccc;" />
                            <%--<div  style="width:100px;float: left;margin-left:10px;">--%>
                            <%--<select class="form-control"  style="background-color: rgb(250,250,250);height:30px;">--%>
                            <%--<option name="choose" selected="selected" value="0">00:00</option>--%>
                            <%--<option name="choose"  value="0">01:00</option>--%>
                ...
                <div class="form-group " style="margin-bottom: 10px;border-top: solid 1px #ccc;padding:10px 0;">
                    <label  class="col-sm-1 control-label" style="text-align: left;">提醒<span style="color: red">*</span>：</label>
                    <div class="col-sm-11 "  style="height:27px;color:#666">
                        <label class="checkbox-inline" style="float: left;">
                            <input type="radio" name="isAlert" autocomplete="off"
                                   value="0" <%if(!calendar.getStIsAlert()) {%>checked="checked"<%}%>> 不提醒
                        </label>
                        <label class="checkbox-inline" style="float: left;margin-left:10px;">
                            <input type="radio" name="isAlert"  autocomplete="off"
                                   value="1" <%if(calendar.getStIsAlert()) {%>checked="checked"<%}%>> 提醒
                        </label>
                        <div  style="float: left;margin-left:10px;">
                            <select class="form-control"  style="background-color: rgb(250,250,250);height:30px;padding:0;line-height: 30px;">
                                <option name="choose" selected="selected" value="0">提前15分钟</option>
                            </select>
                        </div>
                    </div>
                </div>
        ...
        <div class="modal-content"style="width: 700px;height: 550px;">
            ...
            <div class="modal-body" style="height:430px;padding:0;">
                <div style="float: left;height:100%;width: 350px;border-right: solid 1px rgb(244,244,244);">
                    <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
                        <div style="heigth:100%;width:300px;float: left;border-radius:4px 0 0 4px;border:solid 1px #cccccc;">
                            <input type="text" class="form-control" style="height:100%;padding:5px;width:260px;border: 0;float: left;"placeholder="请输入姓名或手机号" id="leftlxrinput"/>
                            <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="findlxr(1)"></i>
                        </div>
                    ...
                    <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);">
                        <div class="phonefz" onclick="phonetab(this)" style="border:solid 1px #ccc;border-top:solid 2px rgb(0,103,172);border-bottom:solid 2px white;">内部人员</div>
                        <%--<div class="phonefz" onclick="phonetab(this)">公众人员</div>--%>
                        <%--<div class="phonefz" onclick="phonetab(this)">群组</div>--%>
                    </div>
                    <div style="float: left;height:320px;width:100%;overflow: auto;padding:10px;" class="treediv" id="lxrdiv">
                ...
                <div style="float: left;height:100%;width: 100px;border-right: solid 1px rgb(244,244,244);">
                    <div onclick="addlxr()" class="btn btn-default" style="width:74px;float: left;margin-top:120px;margin-left:13px;">添加&nbsp&gt</div>
                    <div onclick='dellxr()' class="btn btn-default" style="width:74px;float: left;margin-top:12px;margin-left:13px;">删除&nbsp&lt</div>
                    <div onclick="clearlxr()" class="btn btn-default" style="width:74px;float: left;margin-top:120px;margin-left:13px;">清空&nbsp&lt&lt</div>
                </div>
                <div style="float: left;height:100%;width: 248px;">
                    <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
                        <div style="heigth:100%;width:100%;float: left;border-radius:4px;border:solid 1px #cccccc;">
                            <input type="text" class="form-control" style="height:100%;padding:5px;width:198px;border: 0;float: left;"placeholder="请输入姓名或手机号" id="rightlxrinput"/>
                            <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="findlxr(2)"></i>
                        </div>
                    </div>
