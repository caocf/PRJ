...
<div style="width:100%;float:left;line-height: 50px;padding:0 10px;text-align: left;">
  <b style="font-size: 20px;">通讯录</b>
  <span style="float: right;font-size: 14px;">办公助理&gt通讯录</span>
</div>
...
<div style="float: left;width:100%;height:100%;background-color: white;border:solid 1px #ccc;">
  <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);">
    <div class="phonefz" onclick="phonetab(this,1)" style="border:solid 1px #ccc;border-top:solid 2px rgb(0,103,172);border-bottom:solid 2px white;">内部人员</div>
    <%--<div class="phonefz" onclick="phonetab(this,2)">公众人员</div>--%>
    <div class="phonefz" onclick="phonetab(this,3)">群组</div>
  </div>
  <div style="float: left;height:600px;width:100%;overflow: auto;" class="treediv">
    <ul id="messageTree" class="ztree bluetree"></ul>
    <div id="qzbq">
    <button class="btn btn-primary" onclick="addOreditqz('add')" style="float: left;width: 90%;margin-left:5%; margin-bottom: 20px;margin-top:20px;">新建群组</button>
    <%--<div class="qzdiv" onclick="clickqzdiv(this)" onmousemove="mouseoverqzdiv(this)" onmouseout="mouseoutqzdiv(this)">
      <span>群组名称</span>
      <div class="qzidiv" style="margin-right: 10px;">
        <i class="fa fa-trash"></i>
      </div>
      <div class="qzidiv" onclick="addOreditqz('edit')">
...
<div style="float: left;width:69%;height:100%;background-color: white;border:solid 1px #ccc;">
  ...
  <!-- 内部人员搜索栏-->
  <div id='nbryssl' style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
    ...
    <div style="heigth:100%;width:300px;float: left;border-radius:4px 0 0 4px;border:solid 1px #cccccc;margin-left: 20px;">
      <input type="text" class="form-control" style="height:100%;padding:5px;width:260px;border: 0;float: left;"placeholder="请输入用户名或手机号" id="nbuserselectinput"/>
      <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="showUserList('showUserList',1)"></i>
    </div>
    <!-- 暂时去掉高级查询 -->
  ...
  <!-- 公共人员搜索栏-->
  <div id='ggryssl'style="display:none;float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
    <button class="btn btn-default" style="float: left;" >删除</button>
    <div style="heigth:100%;width:300px;float: left;border-radius:4px 0 0 4px;border:solid 1px #cccccc;margin-left: 20px;">
      <input type="text" class="form-control" style="height:100%;padding:5px;width:260px;border: 0;float: left;"placeholder="请输入用户名或手机号" id="gguserselectinput"/>
    ...
    <i class="fa fa-angle-down" style="float: left;height:32px;width:28px;line-height: 30px;cursor:pointer;text-align: center;border:solid 1px #ccc;border-left:0;background-color: rgb(250,250,250)"></i>
    <button class="btn btn-primary" style="float: right;" data-toggle="modal" data-target="#addgguserModal">添加人员</button>
        ...
        <div style="float: left;width:603px;height:100%;margin-left:15px;">
          ...
          <table class="table" style="background-color: white;border:solid 1px #ccc;">
            ...
            <tr>
              ...
              <td class="col-xs-10">
                <input class="from-control" type="text" style="border: 0;"placeholder="请输入执法证编号" id="lawcode_edit" name="lawcode"/>
              </td>
            </tr>
            <%--<tr>
            ...
            <tr>
              ...
              <td class="col-xs-10">
                <input class="from-control" type="text" style="border: 0;" placeholder="请输入序号" id="order_edit" name="order"/>
              </td>
            </tr>
          </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="width:800px;height:620px;">
      <div class="modal-header">
        ...
        <%--<button type="button" onclick="editDetail()" class="close" data-toggle="modal" data-target="#editbguserModal"
                data-dismiss="modal" aria-hidden="true" style="color: rgb(66,131,185);font-size: 14px;margin-right: 20px;">
    ...
    <div class="modal-content"style="width: 720px;height: 670px;">
      ...
      <div class="modal-body" style="height:540px;padding:10px;background-color: rgb(241,242,246);">
        <div style="height:40px;float: left;width: 100%;line-height: 40px;padding-left:10px;border: solid 1px #ccc;background-color: white;">
          ...
          <input placeholder="请输入群组名称" id="groupName" name="groupName" type="text" style="height:30px;float:left;border: 0;margin-top:5px;width: 300px;line-height: 30px;padding-left:10px;" />
        </div>
        ...
        <div style="float: left;width: 350px;border-right: solid 1px rgb(244,244,244);">
          <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
            <div style="heigth:100%;width:330px;float: left;border-radius:4px;border:solid 1px #cccccc;">
              <input type="text" class="form-control" style="height:100%;padding:5px;width:290px;border: 0;float: left;"placeholder="请输入姓名或手机号" id="leftlxrinput"/>
              <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="findlxr(1)"></i>
            </div>
          </div>

          <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);">
            <div  style="text-align:center;height: 100%;width: 80px;float: left;line-height: 50px;border:solid 1px #ccc;border-top:solid 2px rgb(0,103,172);border-bottom:solid 2px white;">内部人员</div>
          </div>
