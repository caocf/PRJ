...
<head>
  ...
  <!-- 页面js -->
  <script src="../js/officeAssistant/Office_edit_file.js"></script>
</head>
  <%
...
<section class="content" style="padding-top:0; margin-top: 5px;" >
  <div class="box box-primary" style="border-top: 0;background-color: rgb(241,242,246);margin-bottom: 15px;">
    <form class="form-horizontal" enctype="multipart/form-data" id="knowledgeForm" action="fileSubmit" method="post">
      <div class="box-body">
        <div style="background-color: white;width:100%;padding-top: 10px;box-shadow: 0 0 3px #ccc;">
          <div class="form-group" >
            ...
            <div class="col-sm-11">
              <input type="input" class="form-control" style="border: 0;" id="title" maxlength="60" name="title" placeholder="请输入文章标题，标题文字不能超过60个中文字符" value="<%=knowledgeBase.getStBaseTitle()%>">
            </div>
          </div>
          <div class="form-group" style="margin-bottom: 10px;border-top: solid 1px #ccc;padding-top:10px;">
            ...
            <div class="col-sm-11">
              <input type="input" style="border: 0;" class="form-control" id="keyword" name="keyword" maxlength="30" placeholder="请输入关键字" value="<%=knowledgeBase.getStBaseKeyword()%>">
            </div>
          </div>
          <div class="form-group" style="margin-bottom: 10px;border-top: solid 1px #ccc;padding-top:10px;">
          ...
          <div class="form-group"style="margin-bottom: 0;">
            <textarea id="editor1" name="editor1" rows="10" cols="80" placeholder="请输入文章内容"><%=knowledgeBase.getStBaseContent()%></textarea>
            <script>
              /*  富文本编辑器  */
              $(function () {
      ...
      <input type="hidden" name="knowledgeBaseId" id="knowledgeBaseId" value="<%=knowledgeBase.getStBaseId()%>"/>
      <input type="hidden" name="structureId" id="structureId" value="<%=knowledgeBase.getStStructureId()%>"/>
    </form>
  </div><!-- /. box -->
</section>
</body>
