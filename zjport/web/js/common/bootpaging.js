function pagingmake(actionname,functionname,page,pages){
	//总页数pages为1时，隐藏分页
	$("#pagination").html('');
	//if(parseInt(pages)<=1){
	//	$("#pageshow").hide();
	...
	//首页，末页，上一页，下一页
	var firstpageli="<li "+firstpage+"><a "+isfirstonclick+"><span aria-hidden='true'><abbr title='首页'><i class='fa  fa-angle-double-left'></i></abbr></span></a></li>";
	var previous="<li "+firstpage+"><a "+ispreviousonclick+"><span aria-hidden='true'><abbr title='上一页'><i class='fa  fa-angle-left'></i></abbr></span></span></a></li>";
	var lastpageli="<li "+lastpage+"><a "+islastonclick+"><span aria-hidden='true'><abbr title='末页'><i class='fa  fa-angle-double-right'></i></abbr></span></span></a></li>";
	var next="<li "+lastpage+"><a "+isnextonclick+"><span aria-hidden='true'><abbr title='下一页'><i class='fa  fa-angle-right'></i></abbr></span></span></a></li>";
