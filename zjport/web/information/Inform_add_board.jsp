...
<section class="content" style="padding-top:0; margin-top: 5px;">
    <div class="box box-primary" style="border-top: 0;background-color: rgb(241,242,246);margin-bottom: 15px;">
        <form class="form-horizontal" action="informationSubmit" id="boardForm" method="post">
            <div class="box-body">
                <div style="background-color: white;width:100%;padding: 10px 0px;;box-shadow: 0 0 3px #ccc;margin-bottom: 15px;">
                    <div class="form-group" style="margin-bottom: 0;">
                        <label class="control-label" style="float: left;width: 100px;text-align: left;padding-left:10px;">情报板<span style="color: red">*</span>：</label>
                        ...
                        <div style="margin-left:110px;margin-right:110px;padding-left:0;" id="qbbdiv">
                        </div>
                    </div>
                </div>
                ...
                <div class="input-group col-sm-12" style="background-color: white;">
                    <div class="form-group "
                         style="margin-bottom: 0;border: solid 1px #ccc;border-bottom:0;padding:10px 0px;">
                        <label class="control-label"
                               style="float: left;width: 100px;text-align: left;padding-left:10px;">请选择色彩：</label>
                        ...
                        <div class="dropdown" style="height:27px;color:#ccc;float: left;width: 100px;">
                            <div type="button" class="btn btn-default dropdown-toggle" id="dropdownMenu1"
                                ...
                                <div style="width:20px;height:20px;float: left;background-color: rgb(90,192,0);"
                                     id="btn_colordiv"></div>
                                <input type="hidden" name="color" id="color"
                                       value="<%=CommonConst.BOARD_COLOR_GREEN%>"/>
                                <span class="caret" style="float: left;margin-left: 10px;margin-top: 10px;"></span>
                            </div>
                            <ul class="dropdown-menu pull-right" role="menu"
                                aria-labelledby="dropdownMenu1"
                                style="width: 100px;margin-top:10px;border: solid 1px #ccc;">
                                <li role="presentation">
                                    <div class='board_color_div' style="background-color: rgb(90,192,0);"
                                         onclick="colorchange(this,<%=CommonConst.BOARD_COLOR_GREEN%>)"></div>
                                    <div class='board_color_div' style="background-color: rgb(242,177,0);"
                                         onclick="colorchange(this,<%=CommonConst.BOARD_COLOR_YELLOW%>)"></div>
                                    <div class='board_color_div' style="background-color: rgb(243,89,89);"
                                         onclick="colorchange(this,<%=CommonConst.BOARD_COLOR_RED%>)"></div>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <textarea id="editor1" name="editor1" placeholder="请输入文章内容"
                              style="resize:none;height:400px;width: 100%;box-shadow: 0px 0px 3px #ccc;border:0;padding: 10px;">
                    </textarea>
                </div>
                <div class="form-group "
            ...
            <input type="hidden" name="informObject" id="boards"/>
                ...
                <div style="float: left;height:100%;width: 350px;border-right: solid 1px rgb(244,244,244);">
                    <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
                        <div style="heigth:100%;width:300px;float: left;border-radius:4px 0 0 4px;border:solid 1px #cccccc;">
                            <input type="text" id='leftqbbinput' class="form-control"
                                   style="height:100%;padding:5px;width:260px;border: 0;float: left;"
                                   placeholder="请输入..."/>
                            <i class="fa fa-search" onclick="findqbb(1)"
                               style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;"></i>
                        </div>
                ...
                <div style="float: left;height:100%;width: 248px;">
                    <div style="float: left;height:50px;width:100%;border-bottom: solid 1px rgb(244,244,244);padding:10px;">
                        <div style="heigth:100%;width:100%;float: left;border-radius:4px;border:solid 1px #cccccc;">
                            <input type="text" id='rightqbbinput' class="form-control"
                                   style="height:100%;padding:5px;width:198px;border: 0;float: left;"
                                   placeholder="请输入..."/>
                            <i class="fa fa-search" onclick="findqbb(2)"
                               style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;"></i>
                        </div>
                    </div>
