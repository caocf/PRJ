...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/information/Inform_sendDetail_internet.js" type="text/javascript"></script>
    ...
    <div class="box box-primary" style="border-top: 0;background-color: rgb(241,242,246);margin-bottom: 15px;float:left;box-shadow: 0 0 0 white;">
        <div class="box-body" style="float: left;width: 100%;">
            <div style="float: left;width: 100%;margin-top:20px;">
                <div class="pull-left" >
                <%
                    if(CommonConst.InfoState_Rejected.equals(state)) {
                %>
                    <button type="submit" class="btn btn-primary" onclick="sendAgain(<%=info.getStInformId()%>)">重新发布</button>
                <%
                    }
                %>
                <%
                    if(CommonConst.InfoState_Rejected.equals(state) || CommonConst.InfoState_Wait_Approval.equals(state)) {
                %>
                ...
                %>
                    <%--<button class="btn btn-default" style="margin-left: 10px;">预览</button>--%>
                </div>
            </div>
    ...
    <div class="modal-dialog" style="margin-top:300px;">
        <div class="modal-content" style="width: 400px;">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="deleteIt('<%=info.getStInformId()%>')">
                    确定
                </button>
