...
<head>
    ...
    <script src="../js/information/Inform_approval.js" type="text/javascript"></script>
</head>
<%
    ...
    <div class="box">
        ...
        <div id="generalTabContent" class="tab-content no-margin" style="margin-top:10px;margin-left:8px;height:600px;">
            ...
            <div id="tab-internet" class="tab-pane fade in active" style="position: relative">
                <table class="table table-bordered table-hover col-xs-12" id="internet-appro" style="border-top:none">
                    <thead>
                    <tr>
                        <%--<th width="8%">选择</th>--%>
            ...
            <div id="tab-board" class="tab-pane fade" style="position: relative">
                <table class="table table-bordered table-hover col-xs-12" id="board-appro" style="border-top:none">
                    <thead>
                    <tr>
                        <%--<th width="8%">选择</th>--%>
                        <th width="8%" class="center">序号</th>
