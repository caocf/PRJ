...
<section class="content" style="padding-top:0; margin-top: 5px;">
    <div class="box box-primary" style="border-top: 0;background-color: rgb(241,242,246);margin-bottom: 15px;">
        <form class="form-horizontal" action="informationSubmit" method="post">
            <div class="box-body">
                ...
                <div class="input-group col-sm-12" style="background-color: white;">
                    <div class="form-group " style="margin-bottom: 0;border: solid 1px #ccc;border-bottom:0;padding:10px 0px;">
                        <label class="col-sm-1 control-label">请选择色彩<span style="color: red">*</span>：</label>
                    ...
                    <textarea id="editor1" name="editor1" rows="10" cols="80" placeholder="请输入文章内容"style="resize:none;height:400px;width: 100%;box-shadow: 0px 0px 3px #ccc;border:0;padding: 10px;">
            ...
            <div class="box-footer" style="background-color: rgba(0,0,0,0);">
                <div class="pull-left">
                    ...
                    <%--<button class="btn btn-default"><i class="fa fa-pencil" onclick="javascript :history.back(-1);"></i> 取消</button>--%>
                </div>
