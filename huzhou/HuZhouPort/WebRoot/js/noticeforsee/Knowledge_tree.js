...
function showUserListByDepartmentId(s,kindID,kindName,parentId,parentName){
	...
	$("#user_right").attr("src",$("#basePath").val()+"page/noticeforsee/Knowledgelist.jsp?kindID="+kindID);
...
function firstDepartment(s){
	...
	$("#user_right").attr("src",$("#basePath").val()+"page/noticeforsee/Knowledgelist.jsp?kindID=-1");
}
