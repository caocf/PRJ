...
function paging(selectedPage,totalPage,getDataMethodname,actionName,gotoPageMethodName) {
	...
	*/
	$(".firstBtnSpan").append("<a  href=javascript:"+getDataMethodname+"('"+actionName+"',1)> 首页&nbsp;</a>");
	$(".prevBtnSpan").append("<a href=javascript:"+getDataMethodname+"('"+actionName+"',"+(parseInt(selectedPage)-1)+")>上一页 </a>");										
	$(".nextBtnSpan").append("<a href=javascript:"+getDataMethodname+"('"+actionName+"',"+(parseInt(selectedPage)+1)+")>下一页 </a>");
	$(".lastBtnSpan").append("<a href=javascript:"+getDataMethodname+"('"+actionName+"',"+parseInt(totalPage)+")>尾页&nbsp;</a>");	
...
function showGotoPageSpan(totalPage,selectedPage,gotoPageMethodName,actionName){	
	$(".gotoPageSpan").append("共"+totalPage+"页&nbsp;到第&nbsp;<input class='indexCommon' value="+selectedPage+">&nbsp;页"
...
function cleanNullTitile(){
	$("#NoDataTitle").hide();
	$("#NoDataTitle span").remove();
	$("#NoDataTitle span").empty();	
}
function DataIsNullTitile(){
	$("#NoDataTitle").show();
	$("#NoDataTitle span").remove();
	$("#NoDataTitle span").empty();
	$("#NoDataTitle").append($("<span >暂无相关数据</span>"));
}