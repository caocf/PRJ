...
session.removeAttribute("pUserId"); 
session.removeAttribute("shipName"); 
session.invalidate(); 
%>
...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/sailing/login.css" />
		<script src="js/common/jquery-1.5.2.min.js"></script>
		<script type="text/javascript" src="js/sailing/saillogin.js"></script>
	...
	<div id="content">
		...
		<div id="l3">
			<div id="l2">
				<img src="image/top/sailtop_icon.png"  />
			</div>
			<div id="l4">
				...
				<table border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
						...
						<td class="txt3" valign="top">
							<img src="validateCode.action?s=0.9002390058856825"
					...
					<tr>
						<td>
							<img src="image/login/bt_login_normal.png" class="btnLogin"
								onclick="sailLogin()" onmouseover="LoginOver(this)"
			...
			<div class="Qr_code_div">
				<div class="Qr_code">
					<img src="image/app/public.png" style="width:210px;height:220px;"/>
				</div>
				<div class="text_div">扫一扫二维码，下载APP</div>
			</div>
		</div>
		</div>
</div>
