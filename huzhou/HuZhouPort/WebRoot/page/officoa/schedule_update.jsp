...
<html>
  <head>
	...
	<script type="text/javascript" src="js/officoa/schedule.js"></script>
 	<script type="text/javascript" src="js/officoa/schedule_update.js"></script>
  ...
  <form action="updateByEventId" encType="multipart/form-data"  method="post" onSubmit="return update_submit();" >
  	...
  	<div id="showEvent">
	<input type="hidden" id="eventId" value="<%=request.getParameter("eventId") %>" name="scheduleEvent.eventId"/>
	<input type="hidden" id="userId" value="<%=session.getAttribute("userId")%>" name="scheduleEventUser.userId"/>
			...
			<col width="80px"/><col/>
				...
				<tr>
					...
					<td>
						<select name="scheduleEvent.eventKind" id="sKind" class="select_box"></select>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>		
					 <input type="text" name="scheduleEvent.eventTime" id="sTime" value=""  
				...
				<tr>
					...
					<td>
					<select name="scheduleEventUser.eventRemindType" id="eventRemindType" class="select_box">
				...
				<tr>
					...
					<div id="listOfUserName" class="div_text"></div>
				...
				<tr>
					...
					<td>
					<textarea class="textarea_schedule" name='scheduleEvent.eventContent' id="sContent"></textarea>
