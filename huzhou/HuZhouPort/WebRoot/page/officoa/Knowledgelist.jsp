...
<div class="u2_top">
				<div id="u2_top_left">
					<img alt="新增" src="image/operation/add_know_normal.png" class="u3_img" id="addButton"
				...
				<div id="u2_top_right">
					...
					onclick="selectKnowledgelist('selectKnowLedgedian',1)" onMouseOver="SearchOver(this)" onMouseOut="SearchOut(this)"/>
				</div>
			</div>	
