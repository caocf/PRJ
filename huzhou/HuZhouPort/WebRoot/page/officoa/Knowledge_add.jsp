  ...
  <input type="hidden" value="<%=basePath1%>" id="basePath"/>
   ...
   <div id="layer1">
	...
	<col width="100px" /><col width="*"/>
		...
		<tr>
			<td colspan="2">
				<div id="deparmentTreeDiv"  style="border:solid 1px #3d9dd7; width:300px; height:120px;"   >
					<ul  style="list-style-type:none ; margin:20px 0 5px 10px;padding: 0" >
						<li class="li-1" > <img src='image/common/minus.png' style='cursor:default'/> 通知公告
