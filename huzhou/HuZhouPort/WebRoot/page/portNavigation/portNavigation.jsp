...
<%@ page import="com.huzhouport.portNavigation.action.ModelActionNavigation"%>
<%@page import="com.huzhouport.portNavigation.model.ModelPortNavigation"%>
<%
...
<html>
	<head>
		...
		<script type="text/javascript" src="js/portNavigation/portNavigationList.js"></script>
	</head>
