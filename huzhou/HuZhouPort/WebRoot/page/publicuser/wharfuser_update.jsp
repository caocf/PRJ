...
<html>
	<head>
		...
		<script type="text/javascript" src="js/publicuser/wharfuser_update.js"></script>
	...
	<input type="hidden" value="<%=session.getAttribute("username")%>" id="LoginUser" />
		<input type="hidden" value="<%=basePath%>" id="basePath" />
			...
			<div class="totaldiv">
			<form id='updateAction' action='UpdatePublicInfoByWharf' encType="multipart/form-data"
				method="post" >
				...
				<tr>
					...
					<tr>
						<td colspan="2">
							...
							onclick="UpdatePublicByWharf()" onMouseOver="SubmitOver_img(this)"
