...
<script type="text/javascript">
	...
	function downloadWharf() {
		window.location.href ="http://120.55.100.184:90/HuZhouPort/downLastApp?appid=2";
	}
	function is_weixin() {
...
<body style="width:100%;height:100%;margin:0px auto;text-align:center;">
	...
	<img alt="" src="image/weixindown/btn_normal.png" onclick="downloadWharf()" style='position:absolute;margin-top:30px;margin-left:-350px;'/>
