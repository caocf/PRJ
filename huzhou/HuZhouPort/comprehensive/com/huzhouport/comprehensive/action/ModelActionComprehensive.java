package com.huzhouport.comprehensive.action;
...
import com.huzhouport.comprehensive.model.ModelDynmicNews;
import com.opensymphony.xwork2.ModelDriven;

@SuppressWarnings("serial")
public class ModelActionComprehensive extends BaseAction implements
	...
	public int pagesInfo() throws Exception {
		String pageUrl = "http://zjgh.zjt.gov.cn/col/col6718/index.html";
		URL url;
	...
	//		
	// String
	// title=buf.split("\\<\\!--\\<\\$\\[标题\\]\\>begin--\\>")[1].split("\\<\\!\\--\\<\\$\\[标题\\]\\>end--\\>")[0];
	// String
	// content=buf.split("\\<\\!--\\<\\$\\[信息内容\\]\\>begin--\\>")[1].split("\\<\\!--\\<\\$\\[信息内容\\]\\>end--\\>")[0];
	// modelPortDynmicNews.setTitile(title);
