...
public class PushMsgDB extends SQLiteOpenHelper {
	private String TAG = "NotifyPushMsgDB";
	private static final String DB_NAME = "HuZhouPortPublicNotify.db"; // 数据库名称
	...
	public PushMsg findNotifyPushMsg(SQLiteDatabase db, int msgbelong,
			int pushmsgid) {
		Log.d(TAG, "msgbelong:" + msgbelong + " pushmsgid:" + pushmsgid);
		PushMsg msg = null;
		try {
		...
		if (msg == null) {
			...
			Log.e(TAG, "找到数据:" + msg.getPushmsgid());
		}
		return msg;
	}
