...
public class UpdateAppManager
{
	...
	private static final String	FILE_PATH		= Environment
														...
														+ FILE_SEPARATOR;
	// 下载应用存放全路径
	private static final String	FILE_NAME		= FILE_PATH + "huzhoupublicupdate.apk";
	// 更新应用版本标记
	...
	// 以华为天天聊hotalk.apk为例
	private String				spec			= HttpUtil.BASE_URL+"HuZhouMobipublic.apk";
	// 下载应用的对话框
	...
	public int getVerCode()
	{
		...
		try
		{
			verCode = context.getPackageManager().getPackageInfo(
					"com.example.huzhouportpublic", 0).versionCode;
		}
	...
	public String getVerName()
	{
		...
		try
		{
			verName = context.getPackageManager().getPackageInfo(
					"com.example.huzhouportpublic", 0).versionName;
		}
		catch (NameNotFoundException e)
		{
			Log.e(TAG, e.getMessage());
	...
	public int GetNetVersion()
	{
		...
		oHttpInterface = new HttpInterface(HttpUtil.BASE_URL + "verpublic.json");
