...
public class WharfWorkSearch extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		CommonListenerWrapper.commonBackWrapperListener(
				R.id.wharfwork_search_back, this);

		searchtext = (EditText) findViewById(R.id.wharfwork_search_searchtextname);

		findViewById(R.id.wharfwork_search_searchbutton).setOnClickListener(
				new Search());
	}
	...
	public void getWharfWork(String result)
	{
			...
			}
			{
				for (int i = 0; i < jsonArray.length(); i++)
				{
					...
					String text5 = jsonObject.getString("cargoTypes")
							+ jsonObject.getString("carrying") + "吨";
		...
		{
			Toast.makeText(WharfWorkSearch.this, "查找数据失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	...
	public void showWharfWork()
	{
		...
		adapter = new SimpleAdapter(WharfWorkSearch.this, wharfwork,
	...
	class ListTask extends AsyncTask<String, Integer, String>
	{
		...
		protected String doInBackground(String... params)
		{
			...
			cpage = 1;
			String result = query.selectWharfWork(wharfworkid, content, cpage);
