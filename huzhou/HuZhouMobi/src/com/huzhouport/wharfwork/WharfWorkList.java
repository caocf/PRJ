...
public class WharfWorkList extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		ImageButton back = (ImageButton) findViewById(R.id.wharfwork_back);
		back.setOnClickListener(new Back());

		// 搜索的图标
		ImageButton search = (ImageButton) findViewById(R.id.wharfwork_search);
	...
	public void getWharfWork(String result)
	{
		...
		try
		{
			...
			// jsonArray.getJSONArray("recordsDate").opt(0);
		...
		{
			Toast.makeText(WharfWorkList.this, "暂无数据", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	...
	public class NoSearch implements View.OnClickListener
	{
		public void onClick(View v)
		{
			findViewById(R.id.wharfwork_table).setVisibility(View.VISIBLE);
			findViewById(R.id.wharfwork_table2).setVisibility(View.INVISIBLE);
			ListTask task = new ListTask(WharfWorkList.this); // 异步
			task.execute();
		}
	}
	...
	class ListTask1 extends AsyncTask<String, Integer, String>
	{
		protected String doInBackground(String... params)
		{
			...
			String result;
			result = query.showWharfWork1(cpage);
			return result;
		}
