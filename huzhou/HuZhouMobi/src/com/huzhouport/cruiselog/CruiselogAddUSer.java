...
public class CruiselogAddUSer extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchtext.addTextChangedListener(new TextWatcher() {
			...
			public void onTextChanged(CharSequence s, int start, int before, int count) {
		       ...
		       if(content.length()==0){
		    	departmentId="-1";
		    	ListTask task = new ListTask(CruiselogAddUSer.this);  // 异步
		    	task.execute();
		       }else{
...
//			startActivity(intent);
	...
	public class Search implements View.OnClickListener {
		public void onClick(View v) {
			content=searchtext.getText().toString();
		       if(content.length()==0){
		    		Toast.makeText(CruiselogAddUSer.this, "请先在搜索框里输入内容", Toast.LENGTH_SHORT).show();
		       }else{
		    	   ListTask1 task = new ListTask1(CruiselogAddUSer.this);  // 异步
				    task.execute();
		       }
	...
	public class SearchButton implements View.OnClickListener {
		public void onClick(View v) {
			Intent intent = new Intent(CruiselogAddUSer.this,
	...
	class ListTask extends AsyncTask<String ,Integer,String>{
		...
		public ListTask(Context context){
	    	  pDialog = new ProgressDialog(CruiselogAddUSer.this);
			  pDialog.setTitle("提示");
		...
		protected void onPostExecute(String result) {
			...
			showuserlist();
			if(de==1&&us==1){
				Toast.makeText(CruiselogAddUSer.this, "没有数据", Toast.LENGTH_SHORT).show();
			}
	...
	public void  getdepartmentlist(String result){
			...
			try {
			 ...
			 departmentlist.add(departmentlistmap);
				...
				Toast.makeText(CruiselogAddUSer.this, "网络异常", Toast.LENGTH_SHORT).show();
				e.printStackTrace();
			}
	 }
	...
	public void showdepartmentlist(){
		...
		SimpleAdapter adapter = new SimpleAdapter(CruiselogAddUSer.this,departmentlist, R.layout.addresslist_departmentitem, new String[] {"name", "id" }, new int[] { R.id.address_departmentitem_name,R.id.address_departmentitem_id});
	...
	class Departmentlistitem implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
	       ...
	       TextView tv_id=(TextView) arg1.findViewById(R.id.address_departmentitem_id);
			 Intent intent=new Intent(CruiselogAddUSer.this,CruiselogAddUSer.class);
	...
	class Userlistitem implements OnItemClickListener{
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
	        ...
	        String[] sub=userid.split(",");
	        int number=0;
	       
	        loop:
	        for(int i=0;i<sub.length ;i++){
	        	if(usertv_id.getText().toString().equals(sub[i])){
	        		Toast.makeText(CruiselogAddUSer.this, "不能选择同一个人", Toast.LENGTH_SHORT).show();
	        		number=1;
	        		break loop;
	        	}
	        }
	...
	public void showuserlist(){
		...
		SimpleAdapter adapter = new SimpleAdapter(CruiselogAddUSer.this,userlist, R.layout.leaveandovertime_adduser, new String[] {"name", "id"}, new int[] { R.id.leaveandovertime_adduser_name,R.id.leaveandovertime_adduser_id});
