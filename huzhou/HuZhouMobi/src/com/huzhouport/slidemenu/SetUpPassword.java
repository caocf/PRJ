...
public class SetUpPassword extends Activity {
	...
	class SubmitDate extends AsyncTask<Void, Void, String>{
		...
		protected String doInBackground(Void... params) {
			...
			paramsDate.put("user.userId", user.getUserId());
			paramsDate.put("user.email", tv_oldpassword.getText());
			paramsDate.put("user.password", tv_newPassword.getText());
			HttpFileUpTool hfu = new HttpFileUpTool();
			String actionUrl = HttpUtil.BASE_URL + "ChangePassword";
			String result = null;
			try
			{
