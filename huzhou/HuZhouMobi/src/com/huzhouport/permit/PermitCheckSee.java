...
public class PermitCheckSee extends Activity {
	...
	public void getEvidenceDate(String result) {
		...
		try {
			...
			Toast.makeText(PermitCheckSee.this, "补充信息获取失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
	...
	public void getLocationFromService(String result) {
		...
		try {
			...
			Toast.makeText(PermitCheckSee.this, "位置信息获取失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
...
//						.show();
//			if (result == 1)
//				Toast.makeText(PermitCheckSee.this, "文件已存在", Toast.LENGTH_SHORT)
//						.show();
			if (result == -1)
				Toast.makeText(PermitCheckSee.this, "下载失败", Toast.LENGTH_SHORT)
						.show();
			super.onPostExecute(result);
		}
	...
	public void dialog_down(final int arg2) {
		...
		new AlertDialog.Builder(this).setTitle("下载文档").setMessage("下载"+at_name[arg2]+"？")
	...
	public void initDate(String result) {
		...
		try {
			...
			Toast.makeText(PermitCheckSee.this, "没有搜索到相关数据", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	...
	public void getCheckName(String result2) {
		...
		try {
			...
			Toast.makeText(PermitCheckSee.this, "审核信息获取失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
