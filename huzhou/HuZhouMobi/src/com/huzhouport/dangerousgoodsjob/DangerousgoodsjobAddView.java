...
public void getNeirong(String result){
	...
	try {
		...
		JSONObject	jsonArray=data.getJSONObject("dangerousWorkDeclareBean");
	    ...
	    String workTIme =jsonArray.getString("workTIme").substring(0,jsonArray.getString("workTIme").lastIndexOf(":"));
	    ...
	    if(reviewUserName.equals("0")){   
	    	findViewById(R.id.dangerousgoodsjob_view_reviewUserName).setVisibility(View.GONE);
	    	findViewById(R.id.dangerousgoodsjob_view_reviewUserNameNeirong).setVisibility(View.GONE);
	    	findViewById(R.id.dangerousgoodsjob_view_reviewOpinion_tr).setVisibility(View.GONE);
	    	findViewById(R.id.dangerousgoodsjob_view_reviewTime_tr).setVisibility(View.GONE);
		...
		Toast.makeText(DangerousgoodsjobAddView.this, "网络异常", Toast.LENGTH_SHORT).show();
		e.printStackTrace();
	}
}
