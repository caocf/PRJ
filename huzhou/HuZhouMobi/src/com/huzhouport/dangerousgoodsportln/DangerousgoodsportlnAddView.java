...
public void getNeirong(String result){
	...
	try {
		...
		JSONObject	jsonArray=data.getJSONObject("dangerousArrivalDeclareBean");
		...
		String declareTime =jsonArray.getString("declareTime").substring(0,jsonArray.getString("declareTime").lastIndexOf(":"));
	    ...
	    String portTime =jsonArray.getString("portTime").substring(0,jsonArray.getString("portTime").lastIndexOf(":"));
	    ...
	    if(reviewUserName.equals("0")){   
	    	findViewById(R.id.dangerousgoodsportln_view_reviewUserName).setVisibility(View.GONE);
	    	findViewById(R.id.dangerousgoodsportln_view_reviewUserNameNeirong).setVisibility(View.GONE);
	    	findViewById(R.id.dangerousgoodsportln_view_reviewOpinion_tr).setVisibility(View.GONE);
	    	findViewById(R.id.dangerousgoodsportln_view_reviewTime_tr).setVisibility(View.GONE);
	     ...
	     if(jsonArray.getString("reviewOpinion")==null||jsonArray.getString("reviewOpinion").equals("")){
	    	 reviewOpinionText.setText("无");
	     }else{
	    	 reviewOpinionText.setText(jsonArray.getString("reviewOpinion"));
	     }
	     reviewTimeText.setText(jsonArray.getString("reviewTime").substring(0,jsonArray.getString("reviewTime").lastIndexOf(":")));
		...
		Toast.makeText(DangerousgoodsportlnAddView.this, "网络异常", Toast.LENGTH_SHORT).show();
		e.printStackTrace();
	}
}
