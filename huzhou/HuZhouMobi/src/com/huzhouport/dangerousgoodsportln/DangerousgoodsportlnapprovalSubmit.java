...
public class DangerousgoodsportlnapprovalSubmit extends Activity
{
	...
	class ListTask extends AsyncTask<String, Integer, String>
	{
		...
		protected String doInBackground(String... params)
		{
			...
			/*
			 * UploadActivity.tool.addFile("危险品进港", actionUrl, param1); Intent
			 * intent=new Intent(DangerousgoodsportlnapprovalSubmit.this,
			 * DangerousgoodsportlnList.class); intent.putExtra("User", user);
			 * startActivity(intent); setResult(20); finish();
			 */
		...
		protected void onPostExecute(String result)
		{
			...
			if(user!=null)
			new Log(user.getName(), "审核危险品进港", GlobalVar.LOGCHECK, "")
					.execute();
