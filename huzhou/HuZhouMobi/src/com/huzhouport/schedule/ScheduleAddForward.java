...
public class ScheduleAddForward extends Activity
{
	...
	public void finishAdd()
	{
		...
		{
			Toast.makeText(ScheduleAddForward.this, "请输入日程名称",
					Toast.LENGTH_SHORT).show();
		} else if (tv_user.getText().length() == 0)
		{
			Toast.makeText(ScheduleAddForward.this, "请选择转发对象",
					Toast.LENGTH_SHORT).show();
		} else
		{
			// 提交信息
	...
	class Post extends AsyncTask<Void, Void, String>
	{
		...
		public Post(Context context)
		{
			pDialog = new WaitingDialog().createDefaultProgressDialog(
					ScheduleAddForward.this, this, "提交中,请稍候···");
			pDialog.show();
		}
		...
		protected void onPostExecute(String result)
		{
			...
			if (user != null)
			{
				new Log(user.getName(), "转发日程安排", GlobalVar.LOGSAVE, "")
						.execute();
			}
	...
	class getScheduleKindList extends AsyncTask<Void, Void, String>
	{
		...
		protected void onPostExecute(String result)
		{
			...
			{
				Toast.makeText(ScheduleAddForward.this, "数据获取失败",
						Toast.LENGTH_SHORT).show();
				e.printStackTrace();
			}
