...
public class ScheduleSelectUser extends Activity
{
	...
	public class Back implements View.OnClickListener
	{
		public void onClick(View v)
		{
			...
			{	ChooseAllDepartment();
				...
				new ListTask(ScheduleSelectUser.this).execute();
			}
...
//判断部门里是否全选
	...
	public class Search implements View.OnClickListener
	{
		public void onClick(View v)
		{
			...
			if (content.length() == 0)
			{
				Toast.makeText(ScheduleSelectUser.this, "请先在搜索框里输入内容",
						Toast.LENGTH_SHORT).show();
			}
			else
			{
				new ListTask1(ScheduleSelectUser.this).execute(); // 搜索
			}
		}
	}
	...
	class ListTask extends AsyncTask<String, Integer, String>
	{
		...
		{
			pDialog = new ProgressDialog(ScheduleSelectUser.this);
		...
		protected void onPostExecute(String result)
		{
			...
			if (de == 1 && us == 1)
			{
				Toast.makeText(ScheduleSelectUser.this, "没有数据",
						Toast.LENGTH_SHORT).show();
			}
	...
	public void getdepartmentlist(String result)
	{
		...
		{
			Toast.makeText(ScheduleSelectUser.this, "网络异常", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
		...
		departmentlv.setOnItemClickListener(new OnItemClickListener()
		{
					...
					int position,long id)
			{
				...
				title.setText((String) departmentlist.get(position).get(
						"departmentName"));
				new ListTask(ScheduleSelectUser.this).execute(); // 异步
	...
	{
		SimpleAdapter adapter = new SimpleAdapter(ScheduleSelectUser.this,
	...
	class AdapterListViewCheckboxDepartment extends BaseAdapter
	{
	    ...
	    public AdapterListViewCheckboxDepartment() {
			 mInflater = LayoutInflater.from(ScheduleSelectUser.this);
	    }    
	...
	class GetUserByDepartment extends AsyncTask<String, Integer, String>
	{
		...
		protected String doInBackground(String... params)
		{
			return query.newaddresslistmeeting(params[0]);
		}
		...
		protected void onPostExecute(String result)
		{
			...
			{
				Toast.makeText(ScheduleSelectUser.this, "选择失败",
						Toast.LENGTH_SHORT).show();
				e.printStackTrace();
			}
