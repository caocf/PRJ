...
public class IllegalCheckSee extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if (getIntent().getStringExtra("approvalId") == null)
		{
			bt_gotoupdate.setVisibility(View.GONE);
		}

		tv_title.setText(getResources().getString(R.string.illegal_check));
		...
		bt_gotoupdate.setOnClickListener(new OnClickListener()
		{
			...
			public void onClick(View v)
			{
				Intent intent = new Intent(IllegalCheckSee.this,
						IllegalCheck.class);
	...
	public void getEvidenceDate(String result)
	{
		...
		{
			Toast.makeText(IllegalCheckSee.this, "补充信息获取失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
	...
	public void getLocationFromService(String result)
	{
		...
		{
			Toast.makeText(IllegalCheckSee.this, "位置信息获取失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
	...
	class gridViewOnClickListener2 implements OnItemClickListener
	{
				...
				long arg3)
		{
			...
			final int N = arg2;
			new AlertDialog.Builder(IllegalCheckSee.this)
					.setTitle("查看图片")
							...
							new DialogInterface.OnClickListener()
							{
										...
										int which)
								{
									String urlstr = HttpUtil.BASE_URL
											...
											+ at_path2[N];
									new Download().execute(urlstr, at_path2[N]);
								}
	...
	class Download extends AsyncTask<String, Void, Integer>
	{
		...
		protected void onPostExecute(Integer result)
		{
			if(result==0 || result ==1)
				ShowImage.ShowImageBySystemApp(imageURL, IllegalCheckSee.this);
//			if (result == 0)
//				Toast.makeText(IllegalCheckSee.this,
//						GlobalVar.FILE_DOWNLOAD_SUCCESS, Toast.LENGTH_SHORT)
//						.show();
//			if (result == 1)
//				Toast.makeText(IllegalCheckSee.this, "文件已存在",
//						Toast.LENGTH_SHORT).show();
				if (result == -1)
					Toast.makeText(IllegalCheckSee.this, "下载失败",
							Toast.LENGTH_SHORT).show();
			super.onPostExecute(result);
		}
	...
	public void initDate(String result)
	{
		...
		{
			Toast.makeText(IllegalCheckSee.this, "没有搜索到相关数据",
					Toast.LENGTH_SHORT).show();
			e.printStackTrace();
		}
	...
	public void getCheckName(String result2)
	{
		...
		{
			Toast.makeText(IllegalCheckSee.this, "审核信息获取失败", Toast.LENGTH_SHORT)
					.show();
			e.printStackTrace();
		}
	}
	...
	class GetBitmapList extends AsyncTask<Void, Void, Void>
	{
		...
		{
			ma = new MyAdapter(IllegalCheckSee.this, lsmap);
			gv2.setAdapter(ma);
