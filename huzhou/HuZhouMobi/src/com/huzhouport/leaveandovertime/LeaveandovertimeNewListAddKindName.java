...
public class LeaveandovertimeNewListAddKindName extends Activity {
	...
	public void getLeave(String result){
     ...
     public void showLeave(){
    	 SimpleAdapter adapter = new SimpleAdapter(LeaveandovertimeNewListAddKindName.this,leave, R.layout.leaveandovertime_add_item, new String[] {"text1","text2"}, new int[] { R.id.leaveandovertime_add_name,R.id.leaveandovertime_add_id});
