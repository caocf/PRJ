...
public class VerifyCodeUtils{
	...
	public static final String VERIFY_CODES = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNOPQRSTUVWXYZ";//剔除0o Il易混淆字符
//	public static final String VERIFY_CODES = "1234567890";
	 ...
	 * @throws IOException
	 */
	private static void outputImage(int w,
							int h,
							OutputStream os,
...
//		g2.fillRect(0, 0, w, h);
		...
		int fontSize = (int) (Math.min(w/verifySize, h))+2;
