...
public class UserTypeSpinner extends Spinner implements onResult,AdapterView.OnItemSelectedListener
{
	List<String> data_list=new ArrayList<>();
	ArrayAdapter<String> arr_adapter;
	
	public UserTypeSpinner(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private void RequestData()
	{
		...
		hr.post(contants.baseUrl+"UserTypes", map);
	}
	...
	public void onSuccess(String result) 
	{
		try {
			...
			for(int i=0;i<arr.length();i++)
			{
				...
				String nameString=object.getString("typename");
