...
public class SendGoodsMsgActivity extends Activity implements OnClickListener
{
	...
	int typeid=1,fromid=1,toid=1,id=-1;
	...
	private void dataInit()
	{
		...
		tv_good_type.setText(model.goodstypename);
		typeid=Integer.valueOf(model.goodstypeid);
		
		tv_good_name.setText(model.goodsname);
		tv_Load.setText(model.tons);
		tv_hold_style.setText(model.packaging);
					...
					public void onSuccess(Map<String, String> headers, byte[] t) 
					{
						...
						try {
							...
							if (!"".equals(resultcode) && resultcode != null) {
								...
								} else if (Integer.valueOf(resultcode) .intValue() >= 0) 
								{
									Toast.makeText(getApplicationContext(),
