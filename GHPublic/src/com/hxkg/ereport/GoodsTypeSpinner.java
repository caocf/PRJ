...
public class GoodsTypeSpinner extends Spinner implements onResult,AdapterView.OnItemSelectedListener
{
	List<String> data_list=new ArrayList<>();
	ArrayAdapter<String> arr_adapter;
	
	public GoodsTypeSpinner(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private void RequestData()
	{
		...
		hr.post(contants.baseUrl+"EGoodsTypeList", map);
	}
	...
	public void onSuccess(String result) 
	{
		try {
			...
			for(int i=0;i<arr.length();i++)
			{
				...
				String nameString=object.getString("typname");
