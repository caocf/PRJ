...
public class PortSpinner extends Spinner implements onResult,AdapterView.OnItemSelectedListener
{
	List<String> data_list=new ArrayList<>();
	ArrayAdapter<String> arr_adapter;
	
	public PortSpinner(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	...
	private void RequestData()
	{
		...
		hr.post(contants.baseUrl+"DangerPortList", map);
	}
