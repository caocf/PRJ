...
public class ChargeModol
{
    ...
    public String getKPDSMC() {
        return KPDSMC;
    }

    public void setKPDSMC(String KPDSMC) {
        this.KPDSMC = KPDSMC;
    }
    ...
    public void setYJZE(String YJZE) {
        this.YJZE = YJZE;
    }
    ...
    public void setSJZE(String SJZE) {
        this.SJZE = SJZE;
    }
    ...
    public String getKPXLH() {
        return KPXLH;
    }

    public void setKPXLH(String KPXLH) {
        this.KPXLH = KPXLH;
    }
    ...
    public String getKPDSDM() {
        return KPDSDM;
    }

    public void setKPDSDM(String KPDSDM) {
        this.KPDSDM = KPDSDM;
    }
