...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="css/integratedquery/query_zs.css" />
		...
		<script type="text/javascript" src="js/integratedquery/cbzsxx.js"></script>
	...
	<div id="content">
		...
		<col width="150px"/><col width="150px"/><col width="*"/>
		</table>
		<div id="pageDiv">
		<p>
