...
<script src="js/business/dangerousGoodsPortlnApproval.js"></script>
  ...
  <input id="ID" name="ID" type="hidden" value="<%=request.getParameter("ID") %>" />
   ...
   <input type="hidden" value="<%=session.getAttribute("username")%>" id="LoginUser" />
    ...
    <table width="100%" border="0" cellspacing="0" class="see"
	   id="DangerousGoodsPortlnApproval">
	<col width="100px" /><col />
  
  </table>
    <div id="approvaldiv" class="seedivapproval"><p>审批</p></div>
<div id="DangerousGoodsPortlnApprovalDiv">
     <table width="100%" border="0" cellspacing="0" class="see1"
	   id="DangerousGoodsPortlnApproval1">
	<tr>
