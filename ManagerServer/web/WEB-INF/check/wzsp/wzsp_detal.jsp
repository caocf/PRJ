...
<head>
    ...
    <script src="../js/check/wzsp_detal.js" type="text/javascript"></script>
...
<section class="content-header" style="background-color: white;padding: 10px;box-shadow: 0px 3px 3px #ccc;">
    <h1>
        ...
        <a class="btn btn-default" id="hidea" style="padding-left: 10px;display: none" onclick="GoAppro()">审批</a>
    </h1>
</section>
