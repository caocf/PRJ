...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/flie/filecheck_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
            ...
            <div class="col-sm-12">
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    ...
                    <script>
                        ...
                        <button type="button" class="btn btn-primary" onclick="window.location.href='<%=basePath%>file_add?type=1'" style="height:32px;float: right;margin-right:10px;">
                            起草文书
                        </button>
                </div>
            </div>
            ...
            <div id="tab-internet" class="tab-pane fade in active" style="position: relative">
                <table class="table table-hover col-xs-12" id="rolelist-info" style="border-top:none">
                    ...
                    <tr>
                        ...
                        <td>编号</td>
                        <td>编号</td>
                        <td><span class="clickword" onclick="window.location.href='<%=basePath%>file_check'">审批</span></td>
                    </tr>
                </table>
            </div>
