...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/system/systemlog.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
...
<input type="hidden" value="<%=basePath%>" id="basePath"/>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-commenting"></i> 系统设置</a></li>
            <li><a href="#">系统日志</a></li>
        </ol>
    </section>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    ...
                    <div class="worddiv" style="margin-left: 10%;">发布单位：</div>
                    <div class="btn-group" style="float: left;width: 90px;">
                        <button type="button" class="btn btn-default dropdown-toggle"
                    ...
                    <div style="width:378px;float: left;margin-left:5px;border-radius:4px;border:solid 1px #cccccc;">
                        <input type="text" class="form-control" style="height:100%;padding:5px;width:308px;border: 0;float: left;"placeholder="输入用户名查询" id="listkey"/>
                    ...
                    <button class="btn btn-primary" style="float:left; margin-left:40px;" onclick="Search('',1)">查询</button>
                </div>
            </div>
