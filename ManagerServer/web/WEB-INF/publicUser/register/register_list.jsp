...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/publicuser/register_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
    ...
    <section class="content">
                ...
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    <div class="btn-group" style="float: left;width: 90px;">
                        <button type="button" class="btn btn-default dropdown-toggle"
                            ...
                            <span id="typespan">船户</span> <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu " role="menu">
                            <li><a onclick="setlbtype(1)">船户</a></li>
                            <li><a onclick="setlbtype(2)">企业</a></li>
                        </ul>
                    </div>
                    <div style="heigth:100%;width:400px;float: left;margin-left:20px;border-radius:4px;border:solid 1px #cccccc;margin-left: 20px;">
                        <input type="text" class="form-control" style="height:100%;padding:5px;width:330px;border: 0;float: left;"placeholder="请输入用户名" id="listkey"/>
                        ...
                        <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="showTabledata('UsersToCheck',1);"></i>
                    </div>
                    <script>
        ...
        <div id="generalTabContent" class="t  ab-content" style="margin-top:20px;min-height:600px;">
            ...
            <div id="tab-internet" class="tab-pane fade in active" style="position: relative">
                <table class="table table-hover col-xs-12" id="userlist_table" style="border-top:none">
                </table>
            </div>
