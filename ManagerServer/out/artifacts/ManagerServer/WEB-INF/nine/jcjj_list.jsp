...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/nine/jcjj_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
...
<input type="hidden" value="<%=basePath%>" id="basePath"/>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i> 九位码</a></li>
            <li><a href="#">纠错记录</a></li>
        </ol>
    </section>
            ...
            <div class="col-sm-12">
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    <div style="heigth:100%;width:400px;float: left;margin-left:20px;border-radius:4px;border:solid 1px #cccccc;margin-left: 20px;">
                        ...
                        <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="showTabledata('AISList',1);"></i>
                    </div>
                    <script>
