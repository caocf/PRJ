...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/appset/outapp_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
            ...
            <div class="col-sm-12">
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    ...
                    <script>
                        ...
                        <button type="button" class="btn btn-primary" onclick="window.location.href='<%=basePath%>app_add?type=1'" style="height:32px;float: right;margin-right:10px;">
                            发布新版本
                        </button>
                </div>
            </div>
