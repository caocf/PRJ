...
<input type="hidden" id="addtype" value="5"/>
    ...
    <div id="generalTabContent" class="t  ab-content" style="height: 350px;">
      ...
      <div id="tab-internet" class="tab-pane fade in active" style="position: relative">
        <table class="table col-xs-12" id="rolelist-info" style="border-top:none">
          <tr>
            <td>
              <div class="worddiv">出差地点<span>*</span>：</div>
              <input  class="form-control"  placeholder="请输入出差地点" style="float: left;width:300px;" id="ccplace"/>
            </td>
          </tr>
          <tr>
            <td>
              <div class="worddiv">出差时间<span>*</span>：</div>
          ...
          <tr>
            <td>
              <div class="worddiv">出差时长<span>*</span>：</div>
              <span id="qjNo">0</span>
            </td>
          </tr>
          <tr style="height:150px!important;">
            <td>
              <div class="worddiv">出差事由<span>*</span>：</div>
              <textarea id='syword' rows="10" cols="10" style="resize: none;width:60%;height:110px;border: 0;" placeholder="请输入案由"></textarea>
            </td>
          </tr>
          <tr>
            <td>
