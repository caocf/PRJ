...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/calendar/kqsp_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
                ...
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    <div class="btn-group" style="float: left;width: 90px;">
                        <button type="button" class="btn btn-default dropdown-toggle"
                            ...
                            <span id="lbnamespan">类别</span> <span class="caret"></span>
                        </button>
                        ...
                        <div style="heigth:100%;width:400px;float: left;margin-left:20px;border-radius:4px;border:solid 1px #cccccc;margin-left: 20px;">
                            ...
                            <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" ></i>
                        </div>
                    <script>
                    ...
                    <button class="btn btn-primary" style="margin-top:0px;margin-left:10px;" onclick="showTabledata('LeaveAndOvertimefinish',1)">查询</button>
                </div>
            </div>
        </div>
