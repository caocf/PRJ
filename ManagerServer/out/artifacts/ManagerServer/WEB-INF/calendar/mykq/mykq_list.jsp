...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/calendar/mykq_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
            ...
            <div class="col-sm-12">
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    ...
                    <div style="heigth:100%;width:400px;float: left;margin-left:20px;border-radius:4px;border:solid 1px #cccccc;margin-left: 20px;">
                        <input type="text" class="form-control" style="height:100%;padding:5px;width:330px;border: 0;float: left;"placeholder="请输入事由" id="listkey"/>
                        ...
                        <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="showTabledata('LeaveAndOvertimeApply',1)"></i>
                    </div>
                    <script>
                    ...
                    <button class="btn btn-primary" style="margin-top:0px;margin-left:10px;" onclick="showTabledata('LeaveAndOvertimeApply',1)">查询</button>
                    <%--<div style="float:left;">--%>
                        <%--<input type="text" placeholder="起始时间" id="beginTime" onFocus="WdatePicker({maxDate:'#F{$dp.$D(\'endTime\')}',skin:'twoer',dateFmt:'yyyy-MM-dd HH:00',isShowClear:false})" readonly="readonly" class="Wdate" style="float:left;height:30px;line-height: 30px;padding-left:10px;border-radius:4px;border: solid 1px #ccc;" />--%>
                        <%--<span style="float:left;height:35px;line-height: 35px;vertical-align: middle;margin-left:10px;" >至</span>--%>
                        <%--<input type="text" id="endTime" placeholder="结束时间" onFocus="WdatePicker({minDate:'#F{$dp.$D(\'beginTime\')}',skin:'twoer',dateFmt:'yyyy-MM-dd HH:00',isShowClear:false})" readonly="readonly" class="Wdate" style="float:left;margin-left:10px;height:30px;line-height: 30px;padding-left:10px;border-radius:4px;border: solid 1px #ccc;" />--%>
                    <%--</div>--%>
                    <%--<button class="btn btn-primary" style="float: left;margin-left: 10px;height:30px;line-height: 16px;">搜索</button>--%>
                    <div class="btn-group" style="float: right;width: 90px;margin-right:10px;">
                        <button type="button" class="btn btn-primary dropdown-toggle"
                                data-toggle="dropdown" style="width:100%;height:32px;">
                            新增申请 <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu " role="menu">
                            <li><a onclick="window.location.href='<%=basePath%>kqsp_add?id=-1'">请假</a></li>
                            <li><a onclick="window.location.href='<%=basePath%>jbsp_add?id=-1'">加班</a></li>
                            <li><a onclick="window.location.href='<%=basePath%>ccsp_add?id=-1'">出差</a></li>
                        </ul>
                    </div>
                </div>
            </div>
