...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/publicuser/user_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
        ...
        .activelabel{
            ...
            border-top: solid 2px #0072b1!important;
            border-bottom: 0;
        }
    </style>
</head>
...
<input type="hidden" value="<%=basePath%>" id="basePath"/>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-user"></i> 公共用户管理</a></li>
            <li><a href="#">注册审批</a></li>
        </ol>
    </section>
    ...
    <section class="content">
        <div class="box">
            <div class="row" style="padding:0 15px;">
                <div style="width: 100%;float: left;border-bottom: solid 1px #ccc;">
                    <label class="tablabel activelabel">个人-船户</label>
                    <label class="tablabel">企业用户</label>
                </div>
            </div>
        <div class="row">
            <div class="col-sm-12">
                <div id="example1_filter" class="dataTables_filter" style="text-align:left;margin-top: 15px;margin-left:10px">
                    <div class="btn-group" style="float: left;width: 90px;">
                        <button type="button" class="btn btn-default dropdown-toggle"
                            ...
                            <span id="typespan">全部状态</span> <span class="caret"></span>
                        </button>
                        <ul class="dropdown-menu " role="menu">
                            <li><a onclick="setlbtype(-1)">全部状态</a></li>
                            <li><a onclick="setlbtype(0)">禁用</a></li>
                            <li><a onclick="setlbtype(1)">启用</a></li>
                        </ul>
                    </div>
                    <div style="heigth:100%;width:400px;float: left;margin-left:20px;border-radius:4px;border:solid 1px #cccccc;margin-left: 20px;">
                        ...
                        <i class="fa fa-search" style="cursor:pointer;float: left;height:30px;width:28px;line-height: 30px;text-align: center;" onclick="showTabledata('UsersByKey',1)"></i>
                    </div>
                    <script>
            ...
            <div id="tab-internet" class="tab-pane fade in active" style="position: relative">
                <table class="table table-hover col-xs-12" id="kqtable" style="border-top:none">
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="clickword" onclick="window.location.href='<%=basePath%>user_check?type=1'">查看</span>&nbsp;&nbsp;
