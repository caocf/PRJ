...
<head>
    ...
    <!-- 页面js -->
    <script src="../js/commenting/xinxi_list.js" type="text/javascript"></script>
    <style type="text/css">
        .clickword{
            color:rgb(0,104,177);
            cursor: pointer;
            ...
            <div id="tab-internet" class="tab-pane fade in active" style="position: relative">
                <table class="table table-hover col-xs-12" id="kqtable" style="border-top:none">
                    ...
                    <tr>
                        ...
                        <td><%=new Date()%></td>
                        <td><span style="color: rgb(243,177,0)">待审批</span></td>
                        <td><span class="clickword" onclick="window.location.href='<%=basePath%>xinxi_check'">审批</span></td>
                    </tr>
                    <tr>
                        <td>01</td>
                        <td>嘉兴</td>
