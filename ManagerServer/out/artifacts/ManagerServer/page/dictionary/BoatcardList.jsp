...
<html>
	<head>
		...
		<script type="text/javascript" src="js/dictionary/boatcardList.js"></script>
		...
		<div id="content">
			<div id="u2">
				<div class="profession_top">
					...
					onclick="SearchBoatcard('ShowBoatcardListByPage',1)" onMouseOver="SearchOver(this)" onMouseOut="SearchOut(this)"/>
		 ...
		 <!-- 新增或编辑 -->
		  <div class="dialog" id="BoatmanKindDiv" style="display:none;width:360px;height:150px;">
		  		...
		  		<div style="height:30px;margin:20px 0 0 20px;">
		  			...
		  			<span style="width: 80px;display:inline-block;">证书名称</span>
