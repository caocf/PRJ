...
<head>
	...
	<script type="text/javascript" src="js/AddressList/yanhaiqiye_list.js"></script>
	...
	<div id="u2">
		<div class="profession_top">
			<img alt="搜索" src="image/operation/search_normal.png" class="profession_searchbutton"
				 onclick="SearchBoatmanKind('UsersByKey',1)" onMouseOver="SearchOver(this)" onMouseOut="SearchOut(this)"/>
			<input type="text" id="content_search"  class="profession_search_input"/>
		</div>
		<table class='listTable' cellpadding="0" cellspacing="0">
			<col width="10%" /><col width="15%" /><col width="15%" /><col width="15%" />
			<col width="20%" /><col width="15%" /><col width="10%" />
			<tr>
				<th class="firsttdorth">序号</th>
				<th>用户名</th>
				<th>手机号</th>
				<th>用户类型</th>
				<th>注册时间</th>
