...
<html>
	<head>
		...
		<script type="text/javascript" src="js/AddressList/neibuuser_shenhe.js"></script>
	...
	<input type="hidden" value="<%=session.getAttribute("username")%>" id="LoginUser" />
		...
		<div style="float:left;width: 100%;">
			...
			<span class="shenpiwordspan" style="margin-left: 30px;" id="shipxqspan">
				讷河<br>
				pkaqu<br>
				11012011911<br>
				船户<br>
			...
			<div style="float: left;width: 100%;padding: 10px;">
				<label for="passradio">
					<input type="radio" name="radiobutton" id="passradio" value="2" />&nbsp;通过
				</label>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<label for="nopassradio">
					<input type="radio" name="radiobutton" id="nopassradio" value="1"/>&nbsp;驳回
				</label>
			</div>
			<textarea placeholder="请输入意见说明" id="shenheword"></textarea>
			<div style="float: left;width: 100%;margin-top:10px;">
				<button class="btn-pt" onclick="saveshenhe()" style="float: left;margin-left:10px;width: 80px;height:30px;background-color: #0099CC;color: white;">提交</button>
