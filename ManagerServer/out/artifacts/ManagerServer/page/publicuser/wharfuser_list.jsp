...
<html>
	<head>
		...
		<script type="text/javascript" src="js/publicuser/wharfuser_list.js"></script>
	...
	<div id="p1">
		...
		<div class="u2_top">
				<div id="u2_top_left">
					...
					<img alt="码头资料管理" src="image/system/wharfmanage_normal.png" class="u3_img" 
						onclick="GoWharfManage()" onMouseOver="WharfManageOver(this)" onMouseOut="WharfManageOut(this)"/>
				</div>
				<div id="u2_top_right">
					<input type="text" id="search_content" class="search_input_box"/><img alt="查询" 
					src="image/operation/query_normal.png" class="u3_img" 
					onclick="SearchPublicUser('PublicUserListByWharf',1)" onMouseOver="QueryOver(this)" onMouseOut="QueryOut(this)"/>
				</div>
			</div>
