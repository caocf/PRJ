...
<html>
  <head>
	...
	<script type="text/javascript" src="js/shiplog/illegal_add.js"></script>
  	 ...
  	 <form action="AddIllegal" encType="multipart/form-data" 
 		 ...
 		 <div id="layer1">
				<img src="<%=basePath%>image/operation/back_small_normal.png"
					onclick="window.location.href='<%=basePath%>page/shiplog/shiplog.jsp'" onMouseOver="BackSmallOver(this)" 
		...
		<tr>
			...
			<tr>
				...
				<td>
				<input type="text" name="illegal.illegalObject"	id="illegalObject" class="input_box" value='<%=name%>'/>
		...
		<input type="button" value="" class="input_reset" onclick="window.location.href='<%=basePath%>page/shiplog/shiplog.jsp'"
