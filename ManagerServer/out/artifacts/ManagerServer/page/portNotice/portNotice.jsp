...
<%@ page import="com.huzhouport.portNotice.action.ModelActionPortNotice"%>
<%@page import="com.huzhouport.portNotice.model.ModelPortNotice"%>
<%
...
<html>
	<head>
		...
		<script type="text/javascript" src="js/portNotice/portNoticeList.js"></script>
	</head>
