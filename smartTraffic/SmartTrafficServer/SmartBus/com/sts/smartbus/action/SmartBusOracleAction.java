...
public class SmartBusOracleAction {
	 ...
	 * @return
	 */
	public String queryAllLines() {
		try {

			result = this.smartBusOracleService.queryAllLines();
	 ...
	 * @return
	 */
	public String queryAllStations() {
		try {

			result = this.smartBusOracleService.queryAllStations();
	...
	public String queryAllBikes() {
		try {
			...
			result = this.smartBusOracleService.queryAllBikes();
