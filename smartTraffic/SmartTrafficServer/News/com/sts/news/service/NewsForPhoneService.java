...
//		return simulateDetail(id);
	...
	{
		return this.newsDao.queryTzxxs(content, startTime, end);
	}
	
	public List<TZXX> queryTzxxList(int page,int num)
	{
		return this.newsDao.queryTzxxList(page, num);
	}
	
	public TZXX queryTzxxDetail(String id)
	{
		return this.newsDao.queryTzxxDetail(id);
	}
	
	public int countTzxx()
	{
		return this.newsDao.queryTzxxCount();
	}
	
	
	
	public List<JTGZ> queryJTGZList(int page,int num)
	{
		return this.newsDao.queryJTGXList(page, num);
	}
	
	public JTGZ queryJTGZDetail(String id)
	{
		return this.newsDao.queryJtgzDetail(id);
	}
	
	public int countJTGZ()
	{
		return this.newsDao.queryJTGZCount();
	}
