...
var JIAXING_REGION=["南湖区", "秀洲区" ,"嘉善","海盐","海宁","平湖","桐乡"];

var JIAXING_REGIONCODE=[2,3,4,5,6,7,8];

var PATH_GRAPHICAL_PUBLICTRAFFIC_BUS_INFO="图行嘉兴&gt公共交通&gt公交&gt公交概况";
var PATH_GRAPHICAL_PUBLICTRAFFIC_TAXI_INFO="图行嘉兴&gt公共交通&gt出租车&gt出租车概况";
var PATH_GRAPHICAL_PUBLICTRAFFIC_TAXI_COMPANY="图行嘉兴&gt公共交通&gt出租车&gt出租车企业";
var PATH_GRAPHICAL_PUBLICTRAFFIC_TAXI_CALL="图行嘉兴&gt公共交通&gt出租车&gt预约电招";

var PATH_GRAPHICAL_PUBLICTRAFFIC_RIALWAY_TICKECT="图行嘉兴&gt公共交通&gt铁路&gt余票查询";
var PATH_GRAPHICAL_PUBLICTRAFFIC_RIALWAY_IMPORTPORT="图行嘉兴&gt公共交通&gt铁路&gt列车时刻表查询";
var PATH_GRAPHICAL_PUBLICTRAFFIC_RIALWAY_INFO="图行嘉兴&gt公共交通&gt铁路&gt订票热线和代售点";

var PATH_GRAPHICAL_PUBLICTRAFFIC_AIRLINE_TICKECT="图行嘉兴&gt公共交通&gt民航&gt班线查询";
var PATH_GRAPHICAL_PUBLICTRAFFIC_AIRLINE_IMPORTPORT="图行嘉兴&gt公共交通&gt民航&gt列车时刻表查询";
var PATH_GRAPHICAL_PUBLICTRAFFIC_AIRLINE_INFO="图行嘉兴&gt公共交通&gt民航&gt订票热线";
//天地图初始化显示比例
...
function SelectOption(div_id,width){
	...
	$$("#"+div_id+" .CRselectBoxItem a").click(function(){
		...
		GetParking('searchParkingByNameAndTypes', value);
...
//多选的下拉框
function newSelectOption(div_id,width){
	$$("#"+div_id).css("width",width+"px");
	$$("#"+div_id+" .CRselectValue").css("width",(width-30)+"px");
	$$("#"+div_id+" .CRselectBoxOptions").css("width",(width-42)+"px");
	$$("#"+div_id+" .CRselectValue").click(function(){
	...
	$$("#"+div_id+" .CRselectBoxItem a").click(function(){
		...
		var txt = $$(".selected").map(function(){
			return $$(this).text();
		}).get().join(",");
		$$("#"+div_id+" .abc").val(value);
		$$("#"+div_id+" .abc_CRtext").val(txt);
		$$("#"+div_id+" .CRselectValue").text(txt);
		$$("#"+div_id+" .CRselectValue").attr("title",txt);
		//$$("#"+div_id+" .CRselectBoxOptions").hide();
		return false;
	});
	/*点击任何地方关闭层*/
