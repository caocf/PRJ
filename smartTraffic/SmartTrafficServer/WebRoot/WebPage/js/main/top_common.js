...
function ShowWeather(){
	$$.ajax( {
		...
		success : function(data) {
			if(data!=null){
				var weather=data;
				$$("#weather").html(weather.city+"&nbsp;"+weather.weather+"&nbsp;"+weather.l_tmp+"~"+weather.h_tmp+"℃ &nbsp;"+weather.WD);
			}else{
...
function TrafficeWebOver(id) {
	id.src = $$("#basePath").val()
			+ "WebPage/image/main/traffice_web_pressed.png";
}
function TrafficeWebOut(id) {
	id.src = $$("#basePath").val()
			+ "WebPage/image/main/traffice_web_normal.png";
}
//设为首页
function SetHome() {
	if (document.all) {
...
function OpenTrafficMain(){
	...
	window.location.href = basePath + "WebPage/page/firstpage/FirstPage.jsp";
}
//----------------------登录--start-------------------
...
function LoginWeb()
{  
	/*$$("#LoginWindow").attr("src","WebPage/page/register/text.jsp");
...
//-------------------------登录--end-------------------WebPage/page/main/selfInfo.jsp
//个人弹出
var OpenPersonDialog=0;
var OpenAPKDialog=0;
function ShowExitAndPwdDialog(){
	if($$("#APKDIV").attr("display")!="none"){
		$$("#top_layout1_right_login_img2").attr("src","WebPage/image/main/top_arrow_down_black.png");
		$$("#APKDIV").hide(); 
		OpenAPKDialog=0;
	}
	if(OpenPersonDialog==0){
		$$("#top_layout1_right_login_img1").attr("src","WebPage/image/main/top_arrow_up_blue.png");
		$$("#personDiv").show(); 
		OpenPersonDialog=1;
	}else{
		$$("#top_layout1_right_login_img1").attr("src","WebPage/image/main/top_arrow_down_blue.png");
		$$("#personDiv").hide(); 
		OpenPersonDialog=0;
	}
...
function PersonCenter(){
	window.location.href=basePath+"WebPage/page/main/selfInfo.jsp";
}
//apk下载
function ShowAPKDowloadDialog() {
	...
	if(OpenAPKDialog==0){
		$$("#top_layout1_right_login_img2").attr("src","WebPage/image/main/top_arrow_up_black.png");
		$$("#APKDIV").show(); 
		OpenAPKDialog=1;
	}else{
		$$("#top_layout1_right_login_img2").attr("src","WebPage/image/main/top_arrow_down_black.png");
