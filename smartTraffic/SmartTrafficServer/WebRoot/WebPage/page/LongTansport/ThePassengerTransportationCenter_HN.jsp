...
<script type="text/javascript" src="<%=basePath%>WebPage/js/taxi/taxiInfor.js"></script>
  ...
  <body>
   <h4 style="color: rgb(92,92,92);">海宁客运中心 <!--<span style="float: right;font-size: 12px">
   <a  class="main_left_select" onclick="SelectItem_main_left(this,'WebPage/page/LongTansport/ThePassengerTransportationCenter_JX.jsp')">车站简介&nbsp;|</a>换乘引导&nbsp;|车站交通</span>--></h4>
   ...
   <p  style="font-size: 14px;font-weight: normal;letter-spacing: 2px;color:rgb(51,51,51);">
    ...
    <p align="center"><img style="width: 530px;" alt="" src="WebPage/image/LongTansport/ThePassengerTransportationCenter_HN.png"/></p>
  </body>
</html>
