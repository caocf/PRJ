...
<html>
	<head>
		...
		<script type="text/javascript"
			src="WebPage/js/tansport/arriveInfo.js"></script>
			...
			<div id="main_content">
				...
				<div class="layout2">
					...
					<input class="input_text3" value="中文/拼音/首字母" onBlur="TextBlur(this)"
						onFocus="TextFocus(this)"  id="stationName"/>
					
					<img src="WebPage/image/search_normal.png"
						onclick="ShowDataBySearch('GetBusCodeByStationName', 1)"
