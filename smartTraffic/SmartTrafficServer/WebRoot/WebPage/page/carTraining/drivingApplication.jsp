...
<html>
  ...
  <body>
	...
	<jsp:param name="menu_number" value="6,3"/> 
		</jsp:include>
  
   <div id="content1" style="margin-top:10px; ">
      <div class="left_bm">
        <div class="left_bm_top">报名须知</div>
        <div class="left_bm_cont">一、照片：一寸白底彩色证件照2张（注：照片需为本人正面像露出双耳；彩色照片背景必须为纯白色，冲印、数码均可；如考试时需戴眼镜，所交照片要戴眼镜；）。<br/>
...
三、军人学车：现役军人（含武警）申请考领地方驾驶证，须出示本人的军官证、士兵证团级以上单位政治部或政治处出具的证明。（证明信必须为A4纸，注明：杭州市车辆管理所、姓名、性别、出生年月日、证件号、详细现住址）。军人、公安或执法人员须着便装。</div>
      </div>
      <div class="right_bm">您所填写的报名信息，将会作为学车身份确认信息，请务必如实填写。
         ...
         <div class="clear"></div>
          ...
          <div class="input" style="margin-top: 15px;width: 580px">地址
