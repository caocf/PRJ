...
<html>
	<head>
		...
		<script type="text/javascript" src="WebPage/js/Graphical/road.js"></script>
		  ...
		  <div class="layout1">
		   <div class="left">
		      <div class="left_top">
		         ...
		         <a href="WebPage/page/Graphical/road.jsp" class="left_top_text1">公路网查询</a>
		         <a href="WebPage/page/Graphical/channel.jsp" class="left_top_text2" >航道网查询</a>
		      </div>
		       <div class="left_bottom">
		         <div class="left_bottom_wb" style="height: 48px">
		         <div class="left_bottom_wb_nav">
		             <a class="left_bottom_wb_nav1" onClick="SelectItem_top(this,'WebPage/page/Graphical/road_rod.jsp')">道路</a>
		             <a class="left_bottom_wb_nav2" onClick="SelectItem_top(this,'WebPage/page/Graphical/road_ser.jsp')">服务区</a>
		             <a class="left_bottom_wb_nav2" onClick="SelectItem_top(this,'WebPage/page/Graphical/road_char.jsp')">收费站</a>
		             <a class="left_bottom_wb_nav2" onClick="SelectItem_top(this,'WebPage/page/Graphical/road_ext.jsp')">出入口</a>
		         </div>
		         </div>
		          <div id="">
		          <div class="xinbg">
		         <input type="text" class="input" style="margin-top:0px" value="请输入查询的公路信息"  onBlur="TextBlur(this)" onFocus="TextFocus(this)"/>
		         <!--  <a class="input_rig" style="margin-top: -31px;margin-left: 280px">搜索</a>-->
		         ...
		         <div class="tubiao"><img src="WebPage/image/graphical/select.png" style="float:left;margin:7px auto auto 10px;"/>首页</div>
		          ...
		          <!--  <iframe class="down" src="WebPage/page/Graphical/road_rod.jsp" width="1000px" height="100%" scrolling="no" frameborder="0"></iframe>-->
		          <!-- 数据内容 -->                             
		          </div>
		          </div>
		       </div>
