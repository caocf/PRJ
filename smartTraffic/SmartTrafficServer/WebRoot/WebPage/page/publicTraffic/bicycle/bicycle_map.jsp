...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="WebPage/css/publicTraffic/bicycle.css" />
		...
		<script type="text/javascript"
			src="WebPage/js/publicTraffic/bicyccle/bicycle3.js"></script>
	...
	<body>
		<div id="page_content">
			<jsp:include page="../../../../WebPage/page/main/top.jsp" flush="true">
				<jsp:param name="menu_number" value="2,1,2" />
			</jsp:include>
			<!-- 页面内容 -->
			<div id="main_content3">
				<div class="layout1">
					<div class="left">
						<div class="left_top">
							<a href="WebPage/page/publicTraffic/bicycle/ConstructionSurvey.jsp"
								class="left_top_text2">建设概况</a>
							<a href="WebPage/page/publicTraffic/bicycle/bicycle_map.jsp"
					...
					<div class="layout1_right" style="position: relative">
						...
						<tbody>
							...
							<tr>
								...
								<td align="center"><div
										style="background: #f20b0b； height: 15px;  width: 40px;"></div>
								</td>
							</tr>
						</tbody>
					</table>
