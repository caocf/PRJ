...
<link rel="shortcut icon" href="<%=basePath%>favicon.ico" type="image/x-icon" />
		...
		<script type="text/javascript" src="WebPage/js/publicTraffic/wisdom/transfer_search.js"></script>
					...
					<div class="layout1_left">
						...
						<div class="layout3_left">
							...
							<div class="layout1_left_datalist_title">
								...
								<img src="WebPage/image/common/collect.png" onClick="SaveTransferFavor()" />
