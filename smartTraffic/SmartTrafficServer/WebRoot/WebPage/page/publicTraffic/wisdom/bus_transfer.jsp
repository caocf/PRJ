...
<html>
	<head>
		...
		<script src="WebPage/js/common/jquery-ui-1.8.16.custom.min.js"
			language="javascript"></script>
			
		<script type="text/javascript" src="WebPage/js/publicTraffic/wisdom/bus_transfer.js"></script>
				...
				<div class="layout1">
					<div class="layout1_left">
						<div class="map_menu_div">	
								...
								<a class="layout1_a" href="WebPage/page/publicTraffic/wisdom/bus_station.jsp">
									站点查询
								</a>
								<a class="a_select" href="WebPage/page/publicTraffic/wisdom/bus_transfer.jsp">
									换乘查询
								</a>
						...
						<div class="layout3_left">
							<div class="layout3_left_layout1">
								<div class="layout3_left_layout1_left">
									<div class="qizhongdian" style="border-bottom: 1px dashed #ccc">起点
									   <input type="text" style="margin-left: 6px" class="qztext" id="startPoint"  onchange="startPointFocus();"/>
									</div>
									   
								    <div class="qizhongdian">终点
								      <input type="text" style="margin-left: 6px" class="qztext" id="endPoint"  onchange="endPointFocus();"/>    
								    </div>
								...
								<img  src="WebPage/image/graphical/btn_search_normal.png" onMouseOver="BarChangeOver(this)"
							...
							<div class="layout1_left_datalist_title" style="visibility: hidden;">
								...
								<img src="WebPage/image/common/collect.png" onClick="SaveTransferFavor()" style="float: left;margin: 10px 0 0 5px;"/>
