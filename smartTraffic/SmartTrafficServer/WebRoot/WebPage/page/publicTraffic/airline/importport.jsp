		...
		<div id="page_content">
			...
			<div id="main_content">
				<div class="layout1">
					...
					<a href="<%=basePath%>WebPage/page/publicTraffic/airline/airlineinfo.jsp"
					class="layout1_a">订票热线</a>
					<label class="pagepath"><script>document.write(PATH_GRAPHICAL_PUBLICTRAFFIC_AIRLINE_IMPORTPORT)</script></label>
				</div>
				<div class="layout2">
