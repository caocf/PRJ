...
<html>
	<head>
		...
		<link rel="stylesheet" href="<%=basePath%>WebPage/css/taxiInformation/taxiInformation.css" type="text/css"/>
		<link rel="stylesheet" href="<%=basePath%>WebPage/css/trafficNews/trafficNews.css" type="text/css"/>
		<link rel="stylesheet" href="<%=basePath%>WebPage/css/taxiInformation/taxiOverview.css" type="text/css"/>
	...
	<body>
		...
		<div id="page_content">
			<jsp:include page="../../../WebPage/page/main/top.jsp" flush="true">
				<jsp:param name="menu_number" value="9,3" />
			</jsp:include>
			...
			<div id="main">
				<div class="top">
					<div class="top_1">
						<a class="top_select"
							onclick="SelectItem_top(this,'WebPage/page/Passenger/TicketOutlet.jsp')">售票网点</a>
					</div>
					<div class="top_1">
						<a class="top_select_no"
							onclick="SelectItem_top(this,'WebPage/page/Passenger/ShuttleBusTime.jsp')">班车时刻</a>
					</div>
					<div class="top_1">
