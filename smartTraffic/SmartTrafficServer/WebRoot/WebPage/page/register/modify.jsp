...
<html>
  ...
  <jsp:include page="../../../WebPage/page/main/top.jsp" />
    ...
    <div id="content1" style="background-image: url('WebPage/image/register/login_bg.png')">
    	<div class="cont_wz"><label >修改密码</label>&nbsp;&nbsp;&nbsp;<button style="height:30px;width:80px;" onclick="backToModify()">返回</button></div>
        <div class="mod_mima">
