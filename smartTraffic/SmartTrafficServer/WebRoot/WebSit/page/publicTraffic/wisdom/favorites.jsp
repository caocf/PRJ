...
<html>
	<head>
		...
		<script type="text/javascript" src="WebSit/js/publicTraffic/wisdom/favorites.js"></script>
				...
				<div class="layout1">
					<div class="layout1_left">
						<div class="layout1_left_layout1">	
							...
							<!-- 	<a class="layout1_left_layout1_li_yes"  href="WebSit/page/publicTraffic/wisdom/favorites.jsp">
									收藏夹
								</a>	 -->
						</div>
