...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="WebSit/css/publicTraffic/wisdom.css" />
		...
		<script type="text/javascript" src="WebSit/js/publicTraffic/wisdom/road_search.js"></script>
		<script type="text/javascript" src="WebSit/js/publicTraffic/wisdom/way_search.js"></script>
				...
				<div class="layout1">
					<div class="layout1_left">
						<div class="layout1_left_layout1">	
								<a class="layout1_left_layout1_li_yes" href="WebSit/page/publicTraffic/wisdom/road_search.jsp">
									线路查询
								</a>
								<a class="layout1_left_layout1_li" href="WebSit/page/publicTraffic/wisdom/bus_station.jsp">
									站点查询
								</a>
								<a class="layout1_left_layout1_li" href="WebSit/page/publicTraffic/wisdom/bus_transfer.jsp">
									换乘查询
								</a>
