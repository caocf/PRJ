...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="<%=basePath%>WebSit/css/publicTraffic/importport.css" />
		<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript"
			src="WebSit/js/publicTraffic/airline/importport.js"></script>
	...
	<body>
		<div id="page_content">
			<jsp:include page="../../../../WebSit/page/main/top.jsp"
				flush="true">
			...
			<div id="main_content">
				<div class="layout1">
					<a
						href="<%=basePath%>WebSit/page/publicTraffic/airline/ticket.jsp"
