...
/*鼠标移动的css效果*/
 function QueryOver(id){
	 id.src="WebSit/image/illegal/query_hover.png";
 }
 function QueryOut(id){
	 id.src="WebSit/image/illegal/query_normal.png";
 }
 function SearchOver(id){
	 id.src="WebSit/image/firstpage/search_hover.png";
 }
 function SearchOut(id){
	 id.src="WebSit/image/firstpage/search_normal.png";
 }
function FuYunCloseOver(id){
	 id.src="WebSit/image/graphical/close_hover.png";
}
function FuYunCloseOut(id){
	 id.src="WebSit/image/graphical/close_normal.png";
}
function ChangeOver(id){
	 id.src="WebSit/image/publicTraffic/chang_pressed.png";
}
function ChangeOut(id){
	 id.src="WebSit/image/publicTraffic/chang_normal.png";
}
//竖条的搜索img
function BarChangeOver(id){
	 id.src="WebSit/image/graphical/btn_search_hover.png";
}
function BarChangeOut(id){
	 id.src="WebSit/image/graphical/btn_search_normal.png";
}
//输入框内容调换img
function ChangeTextOver(id){
	 id.src="WebSit/image/graphical/btn_change_hover.png";
}
function ChangeTextOut(id){
	 id.src="WebSit/image/graphical/btn_change_normal.png";
}
function ArrowLeftOver(id){
	 id.src="WebSit/image/common/arrow_left_pressed.png";
}
function ArrowLeftOut(id){
	 id.src="WebSit/image/common/arrow_left_normal.png";
}
function ArrowRightOver(id){
	 id.src="WebSit/image/common/arrow_right_pressed.png";
}
function ArrowRightOut(id){
	 id.src="WebSit/image/common/arrow_right_normal.png";
}
//ios版图片效果
function IOSOver(id){
	 id.src="WebSit/image/firstpage/download_IOS_pressed.png";
}
function IOSOut(id){
	 id.src="WebSit/image/firstpage/download_IOS_normal.png";
}
//android版图片效果
function AndroidOver(id){
	 id.src="WebSit/image/firstpage/download_Android_pressed.png";
}
function AndroidOut(id){
	 id.src="WebSit/image/firstpage/download_Android_normal.png";
}
//下载手机版本
...
function GetTimeList(){
	...
	$$("#TimeItem").append($$("<div class='arrow_left'  onclick='TimeListMove_left()'><img onclick='TimeListMove()' " +
			"src='WebSit/image/common/arrow_left_pressed.png' id='arrow_left_img'/></div>"));
	...
	$$("#TimeItem").append($$("<div class='arrow_right'  onclick='TimeListMove_Right()'><img src='WebSit/image/common/arrow_right_normal.png' id='arrow_right_img'/></div>"));
}
function TimeListMove_left(){
	 ...
	 var d=document.getElementById("TimeItem_Outside");
		...
		if(d.scrollLeft==0){
			$$("#arrow_right_img").attr("src","WebSit/image/common/arrow_right_normal.png");
			$$("#arrow_left_img").attr("src","WebSit/image/common/arrow_left_pressed.png");
		}
		else if(d.scrollLeft==506){
			$$("#arrow_right_img").attr("src","WebSit/image/common/arrow_right_pressed.png");
			$$("#arrow_left_img").attr("src","WebSit/image/common/arrow_left_normal.png");
		}else{
			$$("#arrow_right_img").attr("src","WebSit/image/common/arrow_right_normal.png");
			$$("#arrow_left_img").attr("src","WebSit/image/common/arrow_left_normal.png");
		}
