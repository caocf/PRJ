...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/highway/HighWayServiceMap.js"></script>
  ...
  <body>
    <div class="highway_out" id="allheight">
     <input type="hidden" value="<%=request.getParameter("fwqbh")%>" id="fwqbh"/>
    <input type="hidden" value="<%=request.getParameter("sfzbh")%>" id="sfzbh"/>
    <input type="hidden" value="<%=request.getParameter("amount")%>" id="amount"/>
    	<jsp:include page="../system/top.jsp" flush="true" />
    			<div class="highway_left" id="highway_left_info">
					...
					<div style="height:40px;width:100%;" id="service_div">
						<ul class="service_ul">
							<li class="service_li" id="service_li" onclick="searchService(this)">服务区</li>
							<li class="service_li" id="fee_li" onclick="searchFeeStation(this)">收费站</li>
						</ul>
					</div>
					<div class="highway_left_middle" style="height:600px;"></div>
