...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/highway/HighWayStationMap.js"></script>
  ...
  <body>
    ...
    <input type="hidden" value="<%=request.getParameter("stationbh")%>" id="stationbh"/>
    <input type="hidden" value="<%=request.getParameter("amount")%>" id="amount"/>
    	<jsp:include page="../system/top.jsp" flush="true" />
    			<div class="highway_left" id="highway_left_info">
					...
					<div class="highway_left_middle" style="height:640px;"></div>
