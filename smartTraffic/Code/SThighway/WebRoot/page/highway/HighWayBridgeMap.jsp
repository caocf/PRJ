...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/highway/HighWayBridgeMap.js"></script>
    	...
    	<jsp:include page="../system/top.jsp" flush="true" />
    			<div class="highway_left" id="highway_left_info">
					...
					<div class="search_div">
						<input value='桥梁名称' id='search_info' class="search_input" 
							onfocus="TextFocus(this)" onblur="TextBlur(this)" />
						<div class="image_div" onmousemove="imageOver()" onmouseout="imageOut()" onclick="showBridgeInfo('qljbxxlist/qlgklist',1)">
								<img src="image/main/search_normal.png" style="margin-top:9px;" id="search_image"></div>
					</div>
					<div class="highway_left_middle"></div>
