...
<html>
  <head>
	...
	<script type="text/javascript" src="<%=basePath%>js/highway/HighWayGljgMap.js"></script>
    	...
    	<jsp:include page="../system/top.jsp" flush="true" />
    			<div class="highway_left" id="highway_left_info">
					<div class="highway_left_top">
						...
						<div style="height:49px;line-height: 49px;vertical-align: middle;float:right;margin-right:15px;"></div>
					</div>
