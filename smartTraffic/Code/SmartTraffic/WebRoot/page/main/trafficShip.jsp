...
<meta http-equiv="X-UA-Compatible" content="IE=edge"></meta>
	...
	<script type="text/javascript" src="js/main/trafficShip.js"></script>
  </head>
...
<!--      <select class="regionselect">
	...
	<!-- 底部导航栏 -->
     ...
     <div class="list_item" id="tra_shiplink">  
                      船舶监测</div>
 <div class="list_item" id="tra_shiprunlink"><a onclick='document.form1.submit();' target="_blank">船舶运行监测</a></div>
   ...
   <!-- 观测站统计信息div -->
      ...
      <div class="tip_top" style="width:160px\9;">
			<div class="tip_top_textleft">观测站</div>
		</div>
   
	<table class="tip_content" id="gcdTb" cellpadding="2px" cellspacing="0">
