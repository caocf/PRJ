...
<meta http-equiv="X-UA-Compatible" content="IE=edge"></meta>
	...
	<script type="text/javascript" src="js/main/trafficTaxi.js"></script>
  </head>
...
<!--      <select class="regionselect">
	...
	<!-- 底部导航栏 -->
     ...
     <div class="list_item" id="tra_shiprunlink">
      <a onclick='document.form1.submit();' target="_blank">船舶运行监测</a></div>
     </div>
