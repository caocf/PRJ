...
<span id='appname1'></span>的第<span id='appname2'></span>版本</span>&nbsp;>&nbsp;修改
  ...
  <input id="basePath" name="basePath" type="hidden" value="<%=basePath%>">
	...
	<h2>更新日志&nbsp;<textarea rows="" cols="" name="updatelog" id="updatelog" style=" height: 113px; width: 432px; border: solid 1px #e5ebf1;line-height: 20px;resize:none;font-size: 14px;"></textarea>
	</h2><br>
