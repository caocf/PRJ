...
public class BaseDaoImpl<E>  {
	...
	public List<E> queryByIndex(E e, int beginIndex, int pageSize)
		...
		DetachedCriteria detachedCriteria = DetachedCriteria.forClass(e
				.getClass());
		List<E> list = (List<E>) hibernateTemplate.findByCriteria(detachedCriteria,
				beginIndex, pageSize);
		return list;
	}
	...
	public List<E> queryAllData(E e) throws Exception {
		...
		try {
			list = (List<E>) this.hibernateTemplate.findByCriteria(detachedCriteria);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
		return list;
	...
	public List<E> queryDataByManyConditions(String e, String fieldName,
		...
		listData = (List<E>) this.hibernateTemplate.find(sql);
