...
function appendToTable2(list, listLength){
	...
	for ( var i = 0; i < listLength; i++) {
		...
		var image="WebSit/image/map_icon3/"+(i+1)+".png";
		if(backamount==list[i].Count){
			image="WebSit/image/map_icon/"+(i+1)+".png";
		}else if(backamount<list[i].Count*0.8){
			image="WebSit/image/map_icon2/"+(i+1)+".png";
		} 
		...
		newTr.append($$("<div class='addTr_right'><label class='addTr_name'>"+list[i].Name+"</label>" +
						...
						"<br/><label class='addTr_freeCount'>可租数:</label><label  class='addTr_item'>"+rentamount+"</label>" +
						"<label class='addTr_totalCount'>可还数:</label><label class='addTr_item'>"+backamount+"</label>" +
...
function appendToTable2_onload(list, listLength){
	...
	for ( var i = 0; i < listLength; i++) {
		...
		newTr = $$("<div class='addTr' id='addTr"+i+"' onclick='SelectPoint_onload(this,"+i+")'></div>");
		newTr.append($$("<div class='addTr_img'><img src='"+image+"' /></div>"));
		newTr.append($$("<div class='addTr_right'><label class='addTr_name'>"+list[i].name+"</label>" +
						"<label class='addTr_freeCount'>总数:</label><label  class='addTr_item'>"+list[i].count+"</label>" +
						"<label class='addTr_totalCount'>区域名:</label><label class='addTr_item'>"+list[i].areaName+"</label>" +
