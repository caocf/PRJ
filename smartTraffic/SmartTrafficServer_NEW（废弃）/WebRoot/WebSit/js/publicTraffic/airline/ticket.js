...
function appendToTable(list, listLength){
	...
	for ( var i = 0; i < listLength; i++) {
		...
		newTr.append($$("<td><img src='WebSit/image/publicTraffic/startcity.png'/>"+DateIsNull(list[i].startCity,'--')+"<br/>" +
				"<img src='WebSit/image/publicTraffic/endcity.png'/>"+DateIsNull(list[i].endCity,'--')+"</td>"));
