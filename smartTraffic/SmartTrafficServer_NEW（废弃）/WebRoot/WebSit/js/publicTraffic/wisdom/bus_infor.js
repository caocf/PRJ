...
function PageContent(routeId) {
	...
	$$.ajax( {
		...
		success : function(data) {
			...
			')<img  src="WebSit/image/common/refresh.png" onclick=QueryOriginBusArrive("'+routeId+'","'+requestBusStationId+'") style="margin-left: 10px;cursor: pointer;"/></div></div>';
			...
			if(direct==2){
				...
				var html = '<div class="map_bus_div">';
				html+='<div class="map_bus_div1"><label class="map_bus_title">' + StationName + '</label>'+
				'<div class="map_bus_save"><img  class="map_bus_colloct" src="WebSit/image/common/collect.png" onclick=SaveStationFavor(this,"'+requestBusStationId+
