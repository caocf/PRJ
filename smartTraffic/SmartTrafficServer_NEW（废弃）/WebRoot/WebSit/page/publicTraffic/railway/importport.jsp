...
<html>
	<head>
		...
		<script type="text/javascript"
			src="WebSit/js/publicTraffic/railway/importport.js"></script>
		...
		<div id="page_content">
			...
			<div id="main_content">
				<div class="layout1">
                    ...
                    <label style="display: inline-block;line-height: 33px;color: #E7761D;vertical-align: top;">订票电话：021-95105105</label>
				</div>
				<div class="layout2">
