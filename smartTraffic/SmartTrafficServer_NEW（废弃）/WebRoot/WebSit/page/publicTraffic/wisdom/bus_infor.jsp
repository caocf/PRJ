...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"
			href="WebSit/css/publicTraffic/bus_info.css" />
		<link rel="stylesheet" type="text/css"
		...
		<script type="text/javascript" src="<%=basePath%>WebSit/js/publicTraffic/wisdom/bus_infor.js"></script>
		...
		<div id="page_content">
			...
			<input type="hidden" value="<%=request.getParameter("direct")%>" id="direct"/>
				<div class="layout1">
					...
					<div class="layout1_left_top"></div>
				
				<table cellpadding="0" cellspacing="0" class="listTable">
				<tr><th>车牌</th><th>距离</th><th>行驶状态</th></tr>
				</table>
			</div>
                    <div class="layout1_right">
						<div class="layout1_right_layout1">
							...
							<!--<input class="map_bus_right_search"/><input value="搜索" disabled="disabled"  class="map_bus_right_bottom" />-->
						</div>
