...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="<%=basePath%>WebSit/css/taxiInformation/passenger.css" type="text/css"/>
	...
	<body>
		<div id="page_content" >
			...
			<div id="main_content" >
				<div class="layout1">
					<a href="<%=basePath%>WebSit/page/Passenger/TicketOutlet.jsp"
				...
				<div class="layout2">	
					<div class="main_left">
						<a class="main_left_select"
							onclick="SelectItem_main_left(this,'WebSit/page/Passenger/PassengerSurvey_ZX.jsp')" >客运中心班车时刻</a>
						<a class="main_left_select_no"
							onclick="SelectItem_main_left(this,'WebSit/page/Passenger/PassengerSurvey_BZ.jsp')" >北站客运时刻</a>
					</div>
					<div class="main_right">
						<iframe class="right"
							src="WebSit/page/Passenger/PassengerSurvey_ZX.jsp"
