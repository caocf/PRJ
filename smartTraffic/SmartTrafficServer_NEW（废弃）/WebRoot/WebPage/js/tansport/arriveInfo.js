...
function appendToTable(list, listLength){
	...
	for ( var i = 0; i < listLength; i++) {
		...
		newTr.append($$("<td><img src='WebPage/image/publicTraffic/startcity.png'/>"+DateIsNull(list[i].startStation,'--')+"</td>"));
		newTr.append($$("<td><img src='WebPage/image/publicTraffic/endcity.png'/>"+DateIsNull(list[i].endStation,'--')+"</td>"));
