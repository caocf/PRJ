...
function appendToTable(list,listLength){
	$$("#alltotal").text(list.orders.length);
		...
		html1+="<td><img src='WebPage/image/publicTraffic/startcity.png'/>"+DateIsNull(list.startStation,'--')+"</td>";
		html1+="<td><img src='WebPage/image/publicTraffic/endcity.png'/>"+DateIsNull(list.endStation,'--')+"</td>";
