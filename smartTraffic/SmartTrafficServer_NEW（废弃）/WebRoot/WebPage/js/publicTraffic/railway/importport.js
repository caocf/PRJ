...
function appendToTable(list, listLength){
	...
	for ( var i = 0; i < listLength; i++) {
		...
		if(list[i].startKind==0){
			src1="WebPage/image/publicTraffic/startcity.png";
		}else{
			src1="WebPage/image/publicTraffic/pass.png";
		}
		if(list[i].endKind==0){
			src2="WebPage/image/publicTraffic/endcity.png";
		}else{
			src2="WebPage/image/publicTraffic/pass.png";
		}
