...
<html>
	<head>
		...
		<link rel="stylesheet"
			href="<%=basePath%>WebPage/css/taxiInformation/taxiInformation.css"
			type="text/css"></link>
				...
				<div class="top">
					...
					<div class="top_1">
						<a class="top_select_no"
							href="<%=basePath%>WebPage/page/taxiInformation/appointmentCall.jsp">预约电招</a>
					</div>
				</div>
				<div class="page_dowm">
					...
					<p align="center">
						<img src="<%=basePath%>WebPage/image/taxiInfo.jpg" />
					</p>
