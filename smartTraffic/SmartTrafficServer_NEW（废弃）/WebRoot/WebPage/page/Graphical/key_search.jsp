...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>WebPage/js/Graphical/key_search.js"></script>
					...
					<div class="layout1_left">
							<div class="layout1_left_search">
								<input type="text" class="input_text5" value="请输入关键字"
									...
									id="searchContent" />
								<img src="WebPage/image/search_normal.png"  onclick="searchpoibykey('searchpoibykey',1)"
