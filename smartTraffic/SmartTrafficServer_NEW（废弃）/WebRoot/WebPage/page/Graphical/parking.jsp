...
<html>
	...
	<body>
		...
		<jsp:param name="menu_number" value="2,5"/> 
		</jsp:include>
		<!-- 页面内容 -->
					...
					<div class="layout1_left" >
						<table cellpadding="0" cellspacing="0" style="margin-left: 10px;">
							<tr>
								...
								<td rowspan="2">
									<img style="margin-left: 10px" src="WebPage/image/search_normal.png" onMouseOut="SearchOut(this)" onMouseOver="SearchOver(this)"  onclick="GetParking('queryParkingFromCGByNameAndType', 1)" />
								</td>
							</tr>
							<tr>
								<td>
