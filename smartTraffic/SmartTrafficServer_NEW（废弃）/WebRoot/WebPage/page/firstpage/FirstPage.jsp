			...
			<div id="main_content">
				<div class="main_layout1">
					<div class="main_layout1_left">
						...
						<div class="main_layout1_left_layout2">
							...
							<tr>
								<td>
									<div id="main_layout3_img1">
										<img src="<%=basePath%>WebPage/image/firstpage/0000.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0001.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0002.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0003.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0004.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0005.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0006.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0007.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0008.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0009.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0010.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0011.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0012.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0013.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0014.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0015.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0016.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0017.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0018.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0019.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0020.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0022.jpg" onClick="openToLargeImage(this)"/>
										<img src="<%=basePath%>WebPage/image/firstpage/0023.jpg" onClick="openToLargeImage(this)"/>
									</div>
								</td>
								<td>
