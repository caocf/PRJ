				...
				<div class="layout1">
					<div class="layout1_left">
						<div class="layout1_left_layout1">
								...
								<a class="layout1_left_layout1_li_yes" href="WebPage/page/publicTraffic/wisdom/bus_transfer.jsp">
									换乘查询
								</a>
							...
							<div class="layout3_left_layout1">
								<div class="layout3_left_layout1_left">
									<div class="qizhongdian" style="border-bottom: 1px dashed #ccc">起点&nbsp;
									   <input type="text" class="qztext" id="startPoint"  onchange="startPointFocus();"/>
									</div>
