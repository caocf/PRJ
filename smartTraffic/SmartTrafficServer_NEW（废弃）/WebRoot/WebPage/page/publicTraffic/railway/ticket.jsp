...
<html>
	<head>
		...
		<script type="text/javascript"
			src="WebPage/js/publicTraffic/railway/ticket.js"></script>
	...
	<body>
		<div id="page_content">
			<jsp:include page="../../../../WebPage/page/main/top.jsp" flush="true">
				<jsp:param name="menu_number" value="2,1,5" />
			</jsp:include>
			<!-- 页面内容 -->
			<div id="main_content">
				<div class="layout1">
					<a class="a_select">余票查询</a>
					<a href="<%=basePath%>WebPage/page/publicTraffic/railway/importport.jsp"
