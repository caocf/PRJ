...
<html>
  ...
  <body>
   <h4 style="color: rgb(92,92,92);">嘉兴北站</h4>
   ...
   <p  style="font-size: 14px;font-weight: normal;letter-spacing: 2px;color:rgb(51,51,51);">
    ...
    <p align="center"><img style="width: 390px; height: 330px" alt="" src="WebPage/image/LongTansport/ThePassengerTransportationCenter_JX_North.png"/></p>
  </body>
</html>
