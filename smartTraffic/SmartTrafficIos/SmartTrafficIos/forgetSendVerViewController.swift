//
//  forgetSendVerViewController.swift
//  SmartTrafficIos
//
...
class forgetSendVerViewController: UIViewController,UserDelegate {
    ...
    @IBAction func btnNext(sender: UIButton) {
        ...
        else
        {
            ...
            {
                self.performSegueWithIdentifier("segueResetPwd", sender: phoneNumber)
            }
            else
            {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if let segueIdentifier  = segue.identifier
        {
            ...
            {
            case "segueResetPwd":
                let vc = segue.destinationViewController as! forgetEditPwdViewController
    ...
    @IBAction func closeToForgetSendVer(segue: UIStoryboardSegue)
    {
        
        print("closeToForgetSendVer")
    }
