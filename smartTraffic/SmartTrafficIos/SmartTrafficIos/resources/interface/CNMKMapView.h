...
//...是否显示可通行道路
@property (nonatomic) BOOL passableOn;
//...当前地图的经纬度范围，设定的该范围可能会被调整为适合地图窗口显示的范围
@property (nonatomic) CNMKGeoRect region;
//...地图比例尺级别
@property (nonatomic) int getZoomLevel;
 ...
 * dlongitude 经度
 * dlatitude 纬度
 * language 语言，0表示中文，1表示英文
 *************************************************/
- (BOOL)getPoiMessage:(double)dlongitude dlatitude:(double)dlatitude language:(NSInteger)language;

/**************************************************
 * 获取用户当前周边的轨迹信息
 * centerPointLong 当前中心点经度
 * centerPointLat 当前中心点纬度
 * zoomLevel 当前地图比例级别
 *************************************************/
- (BOOL)requestTrack:(double)centerPointLong centerPointLat:(double)centerPointLat zoomLevel:(NSInteger)zoomLevel;
 ...
 * @return 返回值
 *************************************************/
-(NSString *)getPoiSearchTypes;

/**************************************************
 * 得到所有省名称，坐标等信息
 * a_iLanguage 支持的语言 0中文、1英文
 * @return 返回值
 *************************************************/
- (BOOL)getAllProvinceList:(NSInteger)a_iLanguage;
 ...
 * @return 返回值
 *************************************************/
- (BOOL)getProvinceList:(NSString*)provinceCode a_iLanguage:(NSInteger)a_iLanguage;
 ...
 * @return 返回值
 *************************************************/
- (BOOL)getCityList:(NSString*)provinceCode a_iLanguage:(NSInteger)a_iLanguage;
 ...
 * @return 返回值
 *************************************************/
- (BOOL)getAreaList:(NSString*)CityCode a_iLanguage:(NSInteger)a_iLanguage;
 ...
 * @return 返回值
 *************************************************/
- (BOOL)geocoding:(NSInteger)adCode address:(NSString*)address province:(NSString*)province city:(NSString*)city district:(NSString*)district language:(NSInteger)language showbpoint:(NSInteger)showbpoint;
 ...
 * dlongitude 经度
 * dlatitude 纬度
 * type 门址/POI数据或Link数据
 * @return 返回值
 *************************************************/
- (BOOL)reversegeocoding:(double)dlongitude dlatitude:(double)dlatitude type:(NSInteger)type radius:(NSInteger)radius language:(NSInteger)language;

/**************************************************
 * 查询地标，路口，大厦，门址等信息
 * dlongitude 经度
 * dlatitude 纬度
 * type link poi road cross apt
 * count 返回多少条
 * @return 返回值
 *************************************************/
- (BOOL)poiaround:(double)dlongitude dlatitude:(double)dlatitude type:(NSString*)type count:(NSInteger)count radius:(NSInteger)radius language:(NSInteger)language;

/**************************************************
 * 得到所有的查询分类(超市、医院、美食、KTV等等)
 * a_iLanguage 支持的语言 0中文、1英文
 * @return 返回值
 *************************************************/
-(BOOL)getTypesNamesList:(NSInteger)a_iLanguage;
 ...
 * @return 返回值
 *************************************************/
-(BOOL)getTypesLevel1NamesList:(NSString*)adCode a_iLanguage:(NSInteger)a_iLanguage;

/**************************************************
 * 获取二级分类：餐饮->快餐->下级的(kfc)
 * adCode 分类编码
 * a_iLanguage 支持的语言 0中文、1英文
 * @return 返回值
 *************************************************/
-(BOOL)getTypesLevel2NamesList:(NSString*)adCode a_iLanguage:(NSInteger)a_iLanguage;
