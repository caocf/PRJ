...
//...获取画驾车路线的各点(带路况)
-(void)getSDKDrawPointsCBTraffic:(NSString *)FunctionName id2:(CNMKGeoPoint*)PointsGPS id3:(NSInteger)PointsCount id4:(NSArray *)jamcodes id5:(float)distsum;
//...获取驾车路线的分段浏览信息
-(void)getSectionsScanInfo:(NSString *)FunctionName id2:(CNMKGeoPoint *)centerPoints id3:(NSInteger *)zooms id4:(NSInteger *)counts;
