...
typedef struct __driving
{
    ...
    CNMKGeoPoint ServerPoints[1024*1024]; //...返回结果点
...
//...步行路线查询
-(BOOL)stepWalkSearch:(CNMKGeoPoint)startPoint EndPoint:(CNMKGeoPoint)endPoint language:(NSInteger)language directionIconStatus:(NSInteger)directionIconStatus;
