...
public class ZoneIndexAdapter extends BaseAdapter
{
	List<ZoneIndex> data;
	Context context;
	
	public ZoneIndexAdapter(Context context,List<ZoneIndex> data)
	{
		this.data=data;
	...
	public View getView(int position, View convertView, ViewGroup parent) 
	{
		...
		if(position==0)
		{
			...
			TextViewUtil.setText(convertView, R.id.item1, "区域名称");
		...
		{
			TextViewUtil.setText(convertView, R.id.item1, data.get(position-1).getAreaName());
