...
public class TzxxAdapter extends BaseAdapter
{
	private Context context;
	private List<Tzxx> data;

	public TzxxAdapter(Context c, List<Tzxx> data)
	{
		this.context = c;
		this.data = data;
	}
	...
	public void clear()
	{
		this.data = new ArrayList<Tzxx>();
		notifyDataSetChanged();
	}

	public void update(List<Tzxx> data)
	{
		this.data = null;
		this.data = data;
		notifyDataSetChanged();
