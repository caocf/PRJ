...
public class PointTraslation
{
	...
	public static GeoPoint bd_encrypt(GeoPoint p)
	{
		...
		double x = p.getLongitudeE6() * 1.0 / 1e6;
		double y = p.getLatitudeE6() * 1.0 / 1e6;
	...
	{
		double x = p.getLongitudeE6() * 1.0 / 1e6 - 0.0065;
		double y = p.getLatitudeE6() * 1.0 / 1e6 - 0.006;
	 ...
	 * @return 火星坐标
	 */
	public static GeoPoint transform(GeoPoint p)
	{
		double wgLat = p.getLatitudeE6() * 1.0 / 1e6;
		double wgLon = p.getLongitudeE6() * 1.0 / 1e6;
    ...
    public static GeoPoint gcj_To_Gps84(double lat, double lon) {  
        ...
        double lontitude = lon * 2 - gps.getLongitudeE6()*1.0/1e6;  
        double latitude = lat * 2 - gps.getLatitudeE6()*1.0/1e6;  
