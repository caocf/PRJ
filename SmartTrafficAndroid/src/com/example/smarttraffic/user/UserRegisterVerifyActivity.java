 ...
 * 
 */
public class UserRegisterVerifyActivity extends FragmentActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		user = (User) getIntent().getSerializableExtra(
				UserRegisterActivity.USER_INFO);
	...
	public void initHead()
	{
		...
		ManagerFragment.replaceFragment(this, R.id.user_register_verify_head,
				fragment);
	}
	...
	private void requestCode()
	{
		...
		}, new UpdateView()
		{
			...
			public void update(Object data)
			{
				...
				Toast.makeText(UserRegisterVerifyActivity.this,
	...
	public void next(View v)
	{
		if (!code.equals(verifyTextView.getText().toString()))
			Toast.makeText(UserRegisterVerifyActivity.this, "验证码错误",
		...
		else
		{
			...
			StartIntent.startIntentWithParam(this,
					UserRegisterPasswordActivity.class, bundle);
			this.finish();
		}
	}
}
