...
public class CarRepairMoreFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView=inflater.inflate(R.layout.fragment_car_repair_more, container, false);
	...
	{
		suggestTextView=(TextView)rootView.findViewById(R.id.car_repair_more_suggest);
		complainTextView=(TextView)rootView.findViewById(R.id.car_repair_more_complain);
		aboutTextView=(TextView)rootView.findViewById(R.id.car_repair_more_about);
	...
	class onclick implements OnClickListener
	{
		...
		public void onClick(View v) {
			...
			case R.id.car_repair_more_complain:
				Bundle complainBundle=new Bundle();
				complainBundle.putInt(ComplainActivity.COMPLAIN_NAME, 5);
				StartIntent.startIntentWithParam(getActivity(), ComplainActivity.class,complainBundle);

				break;
					
			case R.id.car_repair_more_about:
				Bundle bundle=new Bundle();
				bundle.putInt(AboutActivity.ABOUT_ID, 5);
				StartIntent.startIntentWithParam(getActivity(),AboutActivity.class,bundle);
				break;
				
			case R.id.car_repair_more_suggest:
