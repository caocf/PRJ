...
public class BikeMoreFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView=inflater.inflate(R.layout.fragment_bike_more, container, false);
		
		HeadNameFragment fragment=new HeadNameFragment();
		fragment.setTitleName("更多");
		ManagerFragment.replaceFragment(getActivity(), R.id.bike_more_head, fragment);
	...
	{
		suggestTextView=(TextView)rootView.findViewById(R.id.bike_more_suggest);
		complainTextView=(TextView)rootView.findViewById(R.id.bike_more_complain);
		baseTextView=(TextView)rootView.findViewById(R.id.bike_more_base);
		aboutTextView=(TextView)rootView.findViewById(R.id.bike_more_about);
	...
	class onclick implements OnClickListener
	{
		...
		public void onClick(View v) {
			...
			case R.id.bike_more_complain:
				Bundle complainBundle=new Bundle();
				complainBundle.putInt(ComplainActivity.COMPLAIN_NAME, 8);
				StartIntent.startIntentWithParam(getActivity(), ComplainActivity.class,complainBundle);

				break;
				
			case R.id.bike_more_base:
				Bundle b=new Bundle();
				b.putInt(IntroduceActivity.INTRODUCE_ID, 1);
				StartIntent.startIntentWithParam(getActivity(), IntroduceActivity.class, b);
				break;
	
			case R.id.bike_more_about:
				Bundle bundle=new Bundle();
				bundle.putInt(AboutActivity.ABOUT_ID, 8);
				StartIntent.startIntentWithParam(getActivity(),AboutActivity.class,bundle);
				break;
				
			case R.id.bike_more_suggest:
