 ...
 *
 */
public class CommonSelfStategyActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_common_stategy);
		...
		selectID=getIntent().getExtras().getInt(TripDrivingSelfFragment.STATEGY, 1);
	...
	class onSelectItemClick implements OnItemClickListener
	{
		...
		{
			Toast.makeText(CommonSelfStategyActivity.this, "当前只支持公交线路规划", Toast.LENGTH_SHORT).show();
...
//			selectID=position;
	...
	public List<String> CreateStategy()
	{
		...
		String[] names=getResources().getStringArray(R.array.array_trip_common_stategy);
	...
	public void onclick(View v)
	{
		switch (v.getId())
		{
			case R.id.favor_enter:
				StartIntent.resultActivity(CommonSelfStategyActivity.this, 2, FAVOR_RESULT, selectID);
				break;
		}
	}
