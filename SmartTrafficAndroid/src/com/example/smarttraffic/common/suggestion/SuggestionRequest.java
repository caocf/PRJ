...
{
	public static final String[] SUGGESTION_NAME=new String[]{"默认类型","出行规划","长途客运","铁路信息","民航信息","汽车维修","驾培服务","新闻快讯","公共自行车","智慧公交"};
	private int type;
	...
	public PostParams CreatePostParams()
	{
		...
		postParams.setUrl(HttpUrlRequestAddress.SUGGESTION_SUBMIT_URL);
		...
		param.put("contactPerson", persion);
