...
public class ScheduleAddForwardTime extends Activity {
	...
	public void finishAdd() {
		...
		if (et_name.getText().length() == 0) {
			Toast.makeText(ScheduleAddForwardTime.this, "�������ճ�����",
					Toast.LENGTH_SHORT).show();
		}else if(tv_user.getText().length() == 0){
			Toast.makeText(ScheduleAddForwardTime.this, "��ѡ��ת����",
					Toast.LENGTH_SHORT).show();
		} else {
			// �ύ��Ϣ
			int valueOfRemind;
	...
	class Post extends AsyncTask<Void, Void, String> {
		...
		public Post(Context context) {
			pDialog = new WaitingDialog().createDefaultProgressDialog(ScheduleAddForwardTime.this, this,"�ύ��,���Ժ򡤡���");
			pDialog.show();
		}
	...
	class getScheduleKindList extends AsyncTask<Void, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			try {
				...
				Toast.makeText(ScheduleAddForwardTime.this, "���ݻ�ȡʧ��",
						Toast.LENGTH_SHORT).show();
				e.printStackTrace();
			}
