...
public class MainFramentNewsActivity extends Activity implements onResult,OnRefreshListener2<ListView>
{
	...
	{
		//访问地址
		String toUrl = Constants.BaseURL+"newslist";
	...
	private void initTab()
	{
		...
		{			
			...
			public void onSuccess(String result) 
			{
				try 
				{
					...
					Cursor cursor=db.query("GHM", null, 
		...
		hpHttpRequest.post(Constants.BaseURL+"NewsCountByRegionType", map1);
		Map<String, Object> map2=new HashMap<>();
		map2.put("region", Region+1);
		map2.put("type", vocationstate.getType()+1);
		hpHttpRequest.post(Constants.BaseURL+"NewsCountByRegionType", map2);
		Map<String, Object> map3=new HashMap<>();
		map3.put("region", Region+1);
		map3.put("type", mediaforcus.getType()+1);
		hpHttpRequest.post(Constants.BaseURL+"NewsCountByRegionType", map3);
	}	
