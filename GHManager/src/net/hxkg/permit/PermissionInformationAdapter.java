...
public class PermissionInformationAdapter extends BaseAdapter implements OnClickListener{
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		final ViewHolder holder;
			...
			{
				holder.relative_button.setBackgroundColor(Color.parseColor("#1667b1"));
			}else if(model.getState().equals("通过"))
			{
				holder.relative_button.setBackgroundColor(Color.parseColor("#50be67"));
			}else if(model.getState().equals("未通过"))
			{
				holder.relative_button.setBackgroundColor(Color.parseColor("#ff2323"));
			}
