...
/**
 * CHdSd entity. @author MyEclipse Persistence Tools
 */

public class CHdSd implements java.io.Serializable {
    ...
    @UiInput(group = 1, order = 8, desc = "是否分叉辅航段上", must = false, inputtype = "selectyesno")
    @PropDesc("是否分叉辅航段上")
    ...
    public CHdSd(Double dbszsd, String bh, String mc, String jcnf, String ytfl,
    ...
    public CHdSd(Double dbszsd, Integer id, String bh, String mc, String jcnf,
