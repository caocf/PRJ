...
/**
 * CHdRggcd entity. @author MyEclipse Persistence Tools
 */

public class CHdRggcd implements java.io.Serializable {

    // Fields
    @PropDesc("人工观测点")
    private String rggcdname;
    ...
    public CHdRggcd(Integer id, String bh, String mc, Integer fswlx,
                    Integer sshdaoid, Integer sshduanid, Integer szxzqh,
    ...
    public CHdRggcd(String bh, String mc, Integer fswlx, Integer sshdaoid,
                    Integer sshduanid, Integer szxzqh, Double jd,
