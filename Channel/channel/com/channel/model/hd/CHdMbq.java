...
/**
 * CHdMbq entity. @author MyEclipse Persistence Tools
 */

public class CHdMbq implements java.io.Serializable {
    ...
    @UiInput(groupname = "地理信息", group = 3, order = 1, desc = "管养单位名称", must = false)
    @PropDesc("管养单位名称")
    ...
    public CHdMbq(Integer bws, Integer id, String bh, String mc, String lx,
                  Integer sfah, Integer kbnl, Integer xlzsl, Integer lthxsl,
                  Integer gsksl, Integer zmdsl, Integer cdsssl, Integer fswlx,
    ...
    public CHdMbq(Integer bws, String bh, String mc, Integer sfah,
