...
/**
 * CHdGlz entity. @author MyEclipse Persistence Tools
 */

public class CHdGlz implements java.io.Serializable {
    ...
    @UiInput(group = 1, order = 3, desc = "是否碍航", must = false, inputtype = "selectyesno")
    @PropDesc("是否碍航")
    ...
    public CHdGlz(Integer id, String bh, String mc, Integer sfah,
                  ...
                  Double zyaxzdzbx, Double zyaxzdzby, Integer szxzqh, Integer ab,
                  Integer sffcfhds, String jcnf, String gljgmc, String gljglxr,
    ...
    public CHdGlz(String bh, String mc, Integer sfah, Integer fswlx,
                  Integer sshdaoid, Integer sshduanid, String ssqdlczh, Double zyax,
                  Double zyaxcd, Double zyaxqdzbx, Double zyaxqdzby,
                  Double zyaxzdzbx, Double zyaxzdzby, Integer szxzqh, Integer ab,
                  Integer sffcfhds, String jcnf, String gljgmc, String gljglxr,
                  String gljglxdh, Integer gljgszxzqh, String bz, Integer creater,
                  Date createtime, Date updatetime) {
    ...
    public CHdGlz(Integer sshduanid, String bh, String mc, Integer sfah, Integer fswlx, Integer sshdaoid, String ssqdlczh, Double zyax, Double zyaxcd, Double zyaxqdzbx, Double zyaxqdzby, Double zyaxzdzbx, Double zyaxzdzby, Double jd, Double wd, Integer szxzqh, Integer ab, Integer sffcfhds, String jcnf, String gljgmc, String gljglxr, String gljglxdh, Integer gljgszxzqh, String bz, Integer creater, Date createtime, Date updatetime) {
