...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="page/liuliang/liuliangbymonth.js"></script>
    <script type="text/javascript" language="javascript"
    ...
    <div class="row navcontent shadow border">
        <div class="col-xs-12">
            <div class="row borderbottom">
                <div class="col-xs-12">
                    <p class="nomargin nopadding navcontenttitle">按月流量观测</p>
                </div>
            </div>
            <div class="row borderbottom">
                <div class="col-xs-2">
                ...
                <div class="modal-body">
                    <div class="container-fluid" id="formnew">
                        <div class="row">
                            ...
                            <div class="col-xs-1 text-right" style="width:10%;"><h4
                                    style="margin-top:5px;font-size:16px;">观测月份</h4></div>
                            <div class="col-xs-3 text-left" style="width:25%;" id="divnewtimeregion">
                                <script>
                                    var now = getTimeFmt(new Date(), 'yyyy-MM')
                                    $("#divnewtimeregion").addmonth({
                                        id: 'seldaynew',
                                        hint: '请选择月份',
                                        validators: {notempty: {msg: "请选择观测月份"}},
                                        defaultval: now
                                    });
                                </script>
                            </div>
