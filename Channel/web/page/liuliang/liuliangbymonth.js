        ...
        datafn: function (data) {
            ...
            if (records != null) {
                for (var i in records.data) {
                    ...
                    dt.gcd = sj.mc;
                    dt.type = sj.type;
                    dt.date = sj.starttime.substring(0, 7);
...
function view(id) {
    ajax('querytrafficinfo', {
        ...
        if (ifResultOK(result)) {
            ...
            $("#divviewtimeregion").text(records[0].starttime.substring(0, 7));
...
function updateload(id) {
    ajax('querytrafficinfo', {
        ...
        if (ifResultOK(result)) {
            ...
            var strstarttime = starttime + " 00:00:00";
            var objstarttime = new Date(Date.parse(strstarttime));
            var stime = getTimeFmt(objstarttime, 'yyyy-MM');
            $("#divupdatetimeregion").addmonth({
                id: 'seldayupdate',
                defaultval: stime
            });
