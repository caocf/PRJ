    ...
    <c:choose>
        ...
        <c:otherwise>
            <div class="row">
                <div class="col-xs-12">
                    <center>
                        <h2 class="bbtitle">核查系统船舶流量汇总表<br><br>
            ...
            <div class="row">
                <div class="col-xs-12 text-right bbcontent" id="divgcd">观测点:${cbll.name}</div>
            </div>
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td class="text-center bbcontent" style="vertical-align: middle"
                                rowspan="3" id="tdtime">${mapinfo.starttime}---${mapinfo.endtime}</td>
                            ...
                            <td class="text-center bbcontent" style="vertical-align: middle"></td>
                            <td class="text-center bbcontent" style="vertical-align: middle"></td>
                            <td class="text-center bbcontent" style="vertical-align: middle"></td>
                            <td class="text-center bbcontent" style="vertical-align: middle"></td>
                            <td class="text-center bbcontent" style="vertical-align: middle"></td>
