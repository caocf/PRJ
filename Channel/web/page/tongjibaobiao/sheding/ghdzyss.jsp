            ...
            switch (parseInt(sel)) {
                case 1:
                    ...
                    $('#baobiaoiframe').attr("src",
                            "statistics/queryhdql?loginid=" + $("#userid").val() + "&xzqh=" + xzqh);
                    break;
                case 2:
                    $('#label').html('航标按标志类别');
                    $('#baobiaoiframe').attr("src",
                            "statistics/queryhdhb?loginid=" + $("#userid").val() + "&xzqh=" + xzqh);
                    break;
                case 3:
                    $('#label').html('码头按码头类型');
                    $('#baobiaoiframe').attr("src",
                            "statistics/queryhdmt?loginid=" + $("#userid").val() + "&xzqh=" + xzqh);
                    break;
                case 4:
                    $('#label').html('管线按管线种类');
                    $('#baobiaoiframe').attr("src",
                            "statistics/queryhdgx?loginid=" + $("#userid").val() + "&xzqh=" + xzqh);
                    break;
            }
        }
            ...
            switch (parseInt(sel)) {
                case 1:
                    window.location.href = $("#basePath").val()
                            + "/statistics/exporthdql?loginid="
                            + $("#userid").val() + "&xzqh=" + xzqh;
                    break;
                case 2:
                    window.location.href = $("#basePath").val()
                            + "/statistics/exporthdhb?loginid="
                            + $("#userid").val() + "&xzqh=" + xzqh;
                    break;
                case 3:
                    window.location.href = $("#basePath").val()
                            + "/statistics/exporthdmt?loginid="
                            + $("#userid").val() + "&xzqh=" + xzqh;
                    break;
                case 4:
                    window.location.href = $("#basePath").val()
                            + "/statistics/exporthdgx?loginid="
                            + $("#userid").val() + "&xzqh=" + xzqh;
                    break;
            }
        }
