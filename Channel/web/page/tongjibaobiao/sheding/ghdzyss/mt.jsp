		...
		<c:choose>
			...
			<c:otherwise>
				...
				<div class="row">
					<div class="col-xs-12">
						<center>
							<h2 class="bbtitle">${ret.map.xzqhname}各航道码头分类统计表<br><small class="bbtitle" style="line-height: 40px;">${ret.map.time}</small></h2>
						</center>
					</div>
				</div>
							...
							<thead>
								<tr>
									<th width="150px" class="text-center" style="padding:0 0 0 0;"><img
										...
										style="position: absolute;left:100px;top:5px;">码头类型</label></th>
