...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xs-4 text-right pull-right bbcontent">${mapinfo.selstart }至${mapinfo.selend}</div>
    </div>
    <div class="row">
        <div class="col-xs-12">
            <table class="table table-bordered" style="table-layout: fixed">
                <tr>
                    <td rowspan="2" class="text-center bbcontentbold" style="width:150px;height:50px;line-height:50px;">
                        项目
                    </td>
                    <td rowspan="2" class="text-center bbcontentbold" style="height:50px;line-height:50px;">计量单位</td>
                ...
                <tr>
                    <td class="text-center bbcontentbold">本月</td>
                    <td class="text-center bbcontentbold">累计</td>
                    <td class="text-center bbcontentbold">本月</td>
                    <td class="text-center bbcontentbold">累计</td>
                </tr>
                <tr>
    ...
    <div class="row" style="margin-bottom: 20px;">
        <div class="col-xs-4 pull-left bbcontent">注:1.内河骨干航道例行养护工作，不计列本表中。</div>
    </div>
</div>
</body>
</html>
