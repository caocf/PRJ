            ...
            <table class="table table-bordered" style="table-layout: fixed">
                <tr>
                    <td colspan="2" class="text-center" style="width:200px;padding:0 0 0 0;">
                        ...
                        <label class="bbcontentbold" style="position: absolute;left:140px;top:5px;">航道名称</label>
                    </td>
                ...
                <tr>
                    <td class="text-center bbcontent" colspan="2" style="vertical-align: middle">合计金额(元)</td>
