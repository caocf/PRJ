...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="page/tongjibaobiao/sheding_framework.css">
    ...
    <script type="text/javascript" language="javascript"
            src="page/tongjibaobiao/sheding_framework.js"></script>
    <script type="text/javascript" language="javascript"
    ...
    <div class="row navrow">
        ...
        <div class="col-xs-7">
            ...
            || ui.hasPerm('VIEW_JSYBB')}">
                <a class="btn btn-primary" id="tabfading">法定报表</a>
            </c:if>
            <c:if test="${ui.hasPerm('VIEW_SHENHDBB')||ui.hasPerm('VIEW_SHIHDBB')}">
                <a class="btn btn-primary active" id="tabsheding">设定报表</a>
            </c:if>
        </div>
...
<div style="float:left;width:320px;">
    <div id="divleft" class="navcontentleft borderright"
        ...
        <div id="baobiaotree" style="overflow: auto;"></div>
    </div>
</div>
...
<div id="divright" style="margin-left:335px;">
    <div class="nopadding nomargin"
         style="background:#f0f0f0;float:left;width:98%;margin-top:15px;">
        <div class="col-xs-12"
