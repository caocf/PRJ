...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="page/hdaoinfomap/applist.js"></script>
    <script type="text/javascript" language="javascript"
        ...
        <div class="col-xs-12">
            ...
            <div class="row borderbottom" style="padding:10px 0 10px 0;">
                ...
                <div class="btn btn-primary noborder"
                     style="float:right;border-radius:5px;margin: 0 10px 0 0" onclick="gotoappinfolist(-1,<%=szshixzqh%>);">
                    <i class="icon-search"></i>&nbsp;&nbsp;<label>附属物信息查询</label>
                </div>
            </div>
            ...
            <div class="row" id="printcontent">
                <div class="row">
                    <div class="col-xs-12">
                        <center>
                            <h2 class="bbtitlenosize" id="bbtitle">附属物列表<br><br>
                            </h2>
                        </center>
                    </div>
                </div>
                <div id="divtable" class="col-xs-12 nomargin nopadding">
                    <table class="table text-center" border="1px solid #dddddd" style="border: 1px solid #dddddd"
                           cellspacing="0" width="100%" id="apptable">
                        <thead>
                        <tr>
