...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="page/hdaoinfomap/hduaninfolist.js"></script>
    <script type="text/javascript" language="javascript"
    ...
    <div class="row navcontent shadow border">
        <div class="col-xs-12">
            ...
            <div class="row borderbottom" style="padding:10px 0 10px 0;">
                ...
                <div class="text-right">
                    <label style="float:left;margin-top:8px;">航段等级:</label>
                </div>
                <div class="col-xs-1" id="selhddjdiv">
                    <select class="form-control middleinputgroup" style="margin-left:10px;float:left;width:110px;"
                            id="selhddj">
                    </select>
                </div>
                <div class="text-right">
                    <label style="float:left;margin-top:8px;">航段名称:</label>
                </div>
                <div class="col-xs-2">
                    <input class="form-control" id="hdname" name="hdname">
                </div>
                <div class="col-xs-4">
                    <button class="btn btn-primary" onclick="loadhduaninfolist()">搜索</button>
                </div>
            </div>
