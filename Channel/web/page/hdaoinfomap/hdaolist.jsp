...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="page/hdaoinfomap/hdaolist.js"></script>
    <script type="text/javascript" language="javascript"
        ...
        <div class="col-xs-12">
            <div class="row borderbottom">
                <div class="col-xs-12" style="background-color: #dddddd">
                    <p class="nomargin nopadding navcontenttitle">航道</p>
                </div>
            </div>
            <div class="row borderbottom" style="padding:10px 0 10px 0;">
                ...
                <div class="btn btn-primary noborder"
                     style="float:right;border-radius:5px;margin: 0 10px 0 0" onclick="gotohdaoinfolist(<%=szshixzqh%>,-1);">
                    <i class="icon-search"></i>&nbsp;&nbsp;<label>航道信息查询</label>
                </div>
            </div>
            ...
            <div class="row" id="printcontent">
                <div class="row">
                    <div class="col-xs-12">
                        <center>
                            <h2 class="bbtitlenosize" id="bbtitle">航道列表<br><br>
                            </h2>
                        </center>
                    </div>
                </div>
                <div id="divtable" class="col-xs-12 nomargin nopadding">
                    <table class="table text-center" border="1px solid #dddddd" style="border: 1px solid #dddddd"
                           cellspacing="0" width="100%" id="hdaotable">
                        <thead>
                        <tr>
                            <th width="25%" colspan="2" rowspan="2" style="text-align: center;vertical-align: middle">
                                行政区划
                            </th>
                            <th width="25%" colspan="2">骨干航道</th>
                            <th width="25%" colspan="2">支线航道</th>
                            <th width="25%" colspan="2">总数</th>
                        </tr>
                        <tr>
                            <th width="12.5%">航道数</th>
                            <th width="12.5%">里程</th>
                            <th width="12.5%">航道数</th>
                            <th width="12.5%">里程</th>
                            <th width="12.5%">航道数</th>
